...
| # | 文件路径 | 行数 | 状态 |
|---|---------|------|------|
| 6 | `src/components/installGlobalErrorHandler.ts` | 49 | 🔵 已包含 JSDoc |
| 7 | `src/components/ui/PageContainer.tsx` | 34 | 🟡 部分注释 |
| 8 | `src/components/ui/PageHeader.tsx` | 44 | 🟡 部分注释 |
...
| 文件 | JSDoc 状态 | 缺失内容 |
|------|-----------|---------|
| analysisStore.derived.ts | ✅ 完整 | 在 DATA_DICTIONARY_INDEX.md 中的模块索引 |
| chatStore.derived.ts | ✅ 完整 | 在 DATA_DICTIONARY_INDEX.md 中的模块索引 |
| riskStore.derived.ts | ✅ 完整 | 在 DATA_DICTIONARY_INDEX.md 中的模块索引 |
| signalQualityStore.derived.ts | ✅ 完整 | 在 DATA_DICTIONARY_INDEX.md 中的模块索引 |
...
| 文件 | 原因 |
|------|------|
| `src/components/ui/PageContainer.tsx` | 所有页面的基础容器，应完善文档 |
| `src/components/ui/PageHeader.tsx` | 所有页面的基础组件，应完善文档 |
...
- [ ] 更新 DATA_DICTIONARY_INDEX.md，添加 store 派生模块索引
