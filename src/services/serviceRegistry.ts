...
export const SERVICE_REGISTRY: ReadonlyArray<ServiceRegistryEntry> = [
  ...
  { id: 'CsvExportService', filePath: 'src/services/export/csvExportService', status: 'active' },
  ...
  { id: 'V6DocxExportService', filePath: 'src/services/export/v6DocxExportService', status: 'active' },
