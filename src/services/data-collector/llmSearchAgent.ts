...
function getApiKey(): string | undefined {
  ...
  if (typeof globalThis !== 'undefined' && (globalThis as Record<string, unknown>).__QWEN_API_KEY__ !== null && (globalThis as Record<string, unknown>).__QWEN_API_KEY__ !== undefined) {
    return (globalThis as Record<string, unknown>).__QWEN_API_KEY__ as string
  }
  // 浏览器环境：Vite 环境变量
  try {
    const envKey = import.meta.env.VITE_QWEN_API_KEY
    if (envKey !== null && envKey !== undefined && typeof envKey === 'string' && envKey.length > 0) {
      return envKey
    }
  } catch {
