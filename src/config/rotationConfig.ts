...
> = {
  growth: {
    name: '成长主导期',
    label: '成长',
    color: COLOR_TOKENS.styleGrowth.hex,
  ...
  value: {
    name: '价值修复期',
    label: '价值',
    color: COLOR_TOKENS.styleValue.hex,
  ...
  balanced: {
    name: '均衡震荡期',
    label: '均衡',
    color: COLOR_TOKENS.styleBalanced.hex,
    gzDesc: '以上均不满足',
...
export const ROTATION_FACTORS: RotationFactor[] = [
  {
    ...
    subCount: 5,
    role: '唯一趋势主导，买入核心依据',
    color: COLOR_TOKENS.factorJingqi.hex,
    subs: [
      {
        code: 'F1A',
        name: '行业景气合成指数',
  ...
  },
  {
    ...
    subCount: 4,
    role: '确认机构态度，买入共振条件',
    color: COLOR_TOKENS.factorZijin.hex,
    subs: [
      {
        code: 'F2A',
        name: '北向资金持仓变动',
  ...
  },
  {
    ...
    subCount: 3,
    role: '仅做赔率参考，不独立触发买入',
    color: COLOR_TOKENS.factorGuzhi.hex,
    subs: [
      {
        code: 'F3A',
        name: 'PE/PB近5年历史分位',
  ...
  },
  {
    ...
    subCount: 2,
    role: '风格匹配度，轮动触发条件',
    color: COLOR_TOKENS.factorBeta.hex,
    subs: [
      {
        code: 'F4A',
        name: 'β系数偏离',
  ...
  },
  {
    ...
    subCount: 2,
    role: '量价确认，过滤脉冲信号',
    color: COLOR_TOKENS.factorNengliang.hex,
    subs: [
      {
        code: 'F5A',
        name: '量比(相对60日均量)',
...
export const SIGNAL_GRADES: RotationSignalGrade[] = [
  {
    ...
    position: '全仓位运行',
    action: '景气锁仓，维持高仓位',
    color: COLOR_TOKENS.signalStrong.hex,
    bg: COLOR_TOKENS.bgEmerald50.tailwind,
  },
  {
    minResonance: 7,
    maxResonance: 8,
    ...
    color: COLOR_TOKENS.signalMediumStrong.hex,
    bg: COLOR_TOKENS.bgGreen50.tailwind,
  },
  {
    minResonance: 5,
    maxResonance: 6,
    ...
    position: '首仓试探',
    action: '首仓40%试探，等待确认',
    color: COLOR_TOKENS.signalMedium.hex,
    bg: COLOR_TOKENS.bgBlue50.tailwind,
  },
  {
    minResonance: 3,
    maxResonance: 4,
    ...
    position: '仅观察',
    action: '仅标注标签，不操作',
    color: COLOR_TOKENS.signalWeak.hex,
    bg: COLOR_TOKENS.bgAmber50.tailwind,
  },
  {
    minResonance: 0,
    maxResonance: 2,
    ...
    position: '空仓',
    action: '不操作，继续观察',
    color: COLOR_TOKENS.signalNone.hex,
    bg: COLOR_TOKENS.bgSlate50.tailwind,
  },
]
