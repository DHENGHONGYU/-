...
/** 买点颜色（A 股红涨，买点用红色系）—— 引用 COLOR_TOKENS/COLOR_SHADES，消除硬编码 HEX */
export const BUY_POINT_COLORS: Record<BuyPointType, string> = {
  /** 回踩买点 - 危险红 (red-500) */
  buy_dip: COLOR_TOKENS.danger.hex,
  /** 突破买点 - 橙 (orange-500) */
  buy_pivot: COLOR_TOKENS.orange.hex,
  /** 估值买点 - 紫 (purple-500) */
  buy_safety_margin: COLOR_TOKENS.purple.hex,
  /** 新高买点 - 粉 (pink-500) */
  buy_breakout: COLOR_TOKENS.pink.hex,
  /** 共振买点 - 深红 (red-600，比 red-500 更深以区分普通买点) */
  composite_buy: COLOR_SHADES.red.hex[600],
}

/** 卖点颜色（A 股绿跌，卖点用绿色系）—— 引用 COLOR_TOKENS/COLOR_SHADES，消除硬编码 HEX */
export const SELL_POINT_COLORS: Record<SellPointType, string> = {
  /** 止盈卖点 - 评分高色 (green-500) */
  sell_profit_taking: COLOR_TOKENS.scoreHigh.hex,
  /** 移动止损 - 翠绿 (emerald-500) */
  sell_trailing_stop: COLOR_TOKENS.emerald.hex,
  /** 固定止损 - 深翠绿 (emerald-600，比 emerald-500 更深以区分) */
  sell_stop_loss: COLOR_SHADES.emerald.hex[600],
  /** 共振卖点 - 深绿 (green-600，比 green-500 更深以区分) */
  composite_sell: COLOR_SHADES.green.hex[600],
}
