 ...
 *
 * V11: 补充孤儿路由入口（holdings / review-launch / wizard / stock-score）；
 *      拆分「高级工具」为「开发工具」+ 分散到「系统运维」「模型与工具」；
 *      对齐侧边栏标签与路由描述。
 *
  ...
  analysis: [
    {
      ...
      items: [
        ...
        { key: 'stock-score', label: 'V6 个股评分', path: '/analysis/stock-score', icon: BarChart3 },
    ...
    },
    {
      ...
      items: [
        ...
        { key: 'review-launch', label: '复盘启动分析', path: '/analysis/review-launch', icon: ClipboardCheck },
  ...
  trading: [
    {
      ...
      items: [
        ...
        { key: 'holdings', label: '持仓管理', path: '/trading/holdings', icon: Database },
  ...
  output: [
    {
      ...
      items: [
        ...
        { key: 'wizard', label: '复盘向导', path: '/output/wizard', icon: Wand2 },
      ],
    },
    {
      group: '数据与验证',
