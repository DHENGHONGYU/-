 ...
 *
 * 数据流：CustomAgentPage ↔ useCustomAgentStore ↔ dataLayer.customAgentStore ↔ DataBridge.forward ↔ IDB.custom_agents
 *
 * 设计原则：
 * - 内存态存放 agents 列表与 loading/error
 * - 所有 CRUD 都走 dataLayer → DataBridge → IDB；UI 状态由 action 同步更新
