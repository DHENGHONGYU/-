 ...
 * - 超时错误：显示"请求超时，请稍后重试"
 *
 * @module components/ui/AppErrorState
 * @note 原 ErrorState.tsx 重命名，避免与 states/Error.tsx 组件名冲突
 */

/**
 * @fileoverview AppErrorState - 应用 / 状态组件（Molecule层组件）
 * @module components/molecules/AppErrorState
 */
...
function getErrorInfo(error: Error | string, errorCode?: AppErrorStateProps['errorCode']): ErrorInfo {
