...
import GenericAgentDetail from './GenericAgentDetail'
...
register({
  ...
  detailLink: { to: '/input/pool-board', label: '前往股票池看板' },
})
 ...
 * getAgentComponent
 * @param agentId
 * @returns AgentComponentEntry | undefined
 */
