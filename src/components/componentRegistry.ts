...
export const COMPONENT_REGISTRY: ComponentEntry[] = [
  ...
  { name: 'ConfirmDialog', level: 'molecule', sourcePath: 'src/components/molecules/ConfirmDialog.tsx', targetPath: 'src/components/molecules/ConfirmDialog.tsx', status: 'active', description: '命令式确认对话框（无状态展示组件，配合 useConfirmDialog）' },
  ...
  { name: 'agentComponentRegistry', level: 'organism', sourcePath: 'src/components/organisms/agent/agentComponentRegistry.ts', targetPath: 'src/components/organisms/agent/agentComponentRegistry.ts', status: 'active', description: 'Agent UI 组件注册表（agentId → 详情组件映射）' },
  ...
  { name: 'IndustryHeatmap', level: 'organism', sourcePath: 'src/components/chart/industry/IndustryHeatmap.tsx', targetPath: 'src/components/chart/industry/IndustryHeatmap.tsx', status: 'active', description: '行业热力图' },
  { name: 'IndustryV4Panel', level: 'organism', sourcePath: 'src/components/chart/industry/IndustryV4Panel.tsx', targetPath: 'src/components/chart/industry/IndustryV4Panel.tsx', status: 'active', description: '行业 V4 综合面板' },
  { name: 'IndustryV4Radar', level: 'organism', sourcePath: 'src/components/chart/industry/IndustryV4Radar.tsx', targetPath: 'src/components/chart/industry/IndustryV4Radar.tsx', status: 'active', description: '行业 V4 雷达图' },
  { name: 'SubIndicatorBar', level: 'organism', sourcePath: 'src/components/chart/industry/SubIndicatorBar.tsx', targetPath: 'src/components/chart/industry/SubIndicatorBar.tsx', status: 'active', description: '行业子指标柱状图' },
  { name: 'TrendLineChart', level: 'organism', sourcePath: 'src/components/chart/industry/TrendLineChart.tsx', targetPath: 'src/components/chart/industry/TrendLineChart.tsx', status: 'active', description: '行业趋势折线图' },
  { name: 'ValuationDistribution', level: 'organism', sourcePath: 'src/components/chart/industry/ValuationDistribution.tsx', targetPath: 'src/components/chart/industry/ValuationDistribution.tsx', status: 'active', description: '行业估值分布图' },
