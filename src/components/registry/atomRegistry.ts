...
export const ATOM_REGISTRY: ComponentEntry[] = [
  ...
  { name: 'SkeletonLegacy', level: 'atom', sourcePath: 'src/components/atoms/Skeleton.tsx', targetPath: 'src/components/atoms/Skeleton.tsx', status: 'deprecated', description: '骨架屏（已被 molecules/states/Skeleton 替代，0 消费者）', consumers: [], deprecationMeta: { supersededBy: 'Skeleton (molecules/states)', deprecatedSince: '2026-08-09', removalTarget: '2026-11-01', reason: '0 消费者；molecules/states/Skeleton 使用 THEME_TOKENS 更现代化' } },
