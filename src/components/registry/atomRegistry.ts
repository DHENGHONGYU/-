...
export const ATOM_REGISTRY: ComponentEntry[] = [
  ...
  { name: 'Toaster', level: 'atom', sourcePath: 'src/components/atoms/Toaster.tsx', targetPath: 'src/components/atoms/Toaster.tsx', status: 'active', description: '轻提示', consumers: ['全页面通用', 'useConfirmDialog', 'ScoreUpdateAlert'] },
  ...
  { name: 'Pagination', level: 'atom', sourcePath: 'src/components/atoms/Pagination.tsx', targetPath: 'src/components/atoms/Pagination.tsx', status: 'active', description: '分页器', consumers: ['ScoreHistoryTable', 'PoolList', 'NewsList'] },
  { name: 'DropdownMenu', level: 'atom', sourcePath: 'src/components/atoms/DropdownMenu.tsx', targetPath: 'src/components/atoms/DropdownMenu.tsx', status: 'active', description: '下拉菜单（含 Trigger/Content/Item/CheckboxItem/RadioItem/Label/Group/Separator/Sub）', consumers: ['MultiFactorFilterPanel', 'SourcePrioritySelect', 'TableColumnSettings', 'PageHeader'] },
  { name: 'StockPriceChangeBadge', level: 'atom', sourcePath: 'src/components/atoms/StockPriceChangeBadge.tsx', targetPath: 'src/components/atoms/StockPriceChangeBadge.tsx', status: 'active', description: '股价变化徽章', consumers: ['PoolCard', 'StockInfoCard', 'NewsCard'] },
