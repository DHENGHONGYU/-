            ...
            {cells.map((cell) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center justify-center rounded-lg border border-transparent p-3 text-center transition hover:ring-2 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-400"
                  style={style}
            ...
            <div>
              ...
              <ul className="space-y-1">
                {topGainers.map((cell) => (
                  <li
                    key={`top-${cell.code}`}
                    className="flex justify-between rounded bg-slate-50 px-3 py-2 text-sm dark:bg-slate-800"
                  >
                    <span>{cell.name}</span>
