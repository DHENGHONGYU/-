...
const AgentCustomPage = React.lazy(() => import('@/pages/command/agent/AgentPlaceholderPage'))
const AgentLlmPage = React.lazy(() => import('@/pages/command/agent/AgentPlaceholderPage'))
const AgentCapabilityGraphPage = React.lazy(() => import('@/pages/command/agent/AgentPlaceholderPage'))
const AgentDagSchedulerPage = React.lazy(() => import('@/pages/command/agent/AgentPlaceholderPage'))
