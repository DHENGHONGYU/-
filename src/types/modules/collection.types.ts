...
// ============================================================
// Re-export from Service layer — 防腐层类型桥接
// 允许页面/Hook 层从 @/types/modules 而非 @/services 导入类型
// ============================================================

export type { SourceConnectivityResult } from '@/services/data-collector/dataSourceOrchestrator'
export type { CollectionReport } from '@/services/data-collector/collectionReportService'
export type { CollectionProgress } from '@/services/pool/collectionProgressService'
