...
export interface SkillDevelopment {
  ...
  learningPath: Array<{
    ...
    title: string
    description: string
    resources: Array<{ type: 'book' | 'course' | 'article' | 'video' | 'tool'; title: string; url?: string }>
    exercises: string[]
...
export type { KlinePeriod, KlineAdjust } from '@/services/fetcher/fetcherTypes'
