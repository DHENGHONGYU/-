...
if (typeof window !== 'undefined') {
  ...
  if (!w.getDebugLogs) w.getDebugLogs = getDebugLogs
  if (!w.exportDebugLogs) w.exportDebugLogs = exportDebugLogs
  if (!w.clearDebugLogs) w.clearDebugLogs = clearDebugLogs
  if (!w.setDebugEnabled) w.setDebugEnabled = setDebugEnabled
  if (!w.enableDebugNamespace) w.enableDebugNamespace = enableDebugNamespace
  if (!w.disableDebugNamespace) w.disableDebugNamespace = disableDebugNamespace
  if (!w.createDebugLogger) w.createDebugLogger = createDebugLogger
