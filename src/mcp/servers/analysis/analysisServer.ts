    ...
    return [
      ...
      },
      {
        ...
        handler: async (args) => {
          ...
          const stocks: unknown[] = Array.isArray(parsed) ? parsed : []
          ...
          const results = await runFullIndustryAnalysisEnhanced(
            stocks as Parameters<typeof runFullIndustryAnalysisEnhanced>[0],
            options,
          )
