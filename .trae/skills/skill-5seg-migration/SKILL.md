...
> **版本**: v1.0.0 | **校验基准**: 所有项目级 Skill 强制推广 RULE-TPL 门禁 1.1+
...
- [ ] **全量镜像**：`npm run skill:mirror` 输出「已同步 N 个技能目录 / 清理孤儿 0 个」
...
| 7 | 本次迁移 SOP 已沉淀为 Skill（即本 Skill 存在） | `.trae/skills/skill-5seg-migration/SKILL.md` | 文件存在且 frontmatter/5 段结构合规 |
