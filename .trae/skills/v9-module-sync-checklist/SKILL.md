...
name: v9-module-sync-checklist
version: v1.2.0
last_updated: 2026-07-25
category: code-quality
tags: [sync, checklist, delivery, refactor, code-review, project:finsightv9]
...
triggers:
  ...
  files: ["src/services/**", "src/store/**", "src/core/**", "src/pages/**", "src/components/**", ".trae/skills/**"]
  events: [pre-delivery, refactor, rename, interface-change]
gates: ["npx tsc --noEmit", "npm run tsc:prod", "npm run audit:layers", "npm run audit:acl-consistency"]
mandatory: true
covers_docs: ["V9-DOC-GUIDE-021", "AGENTS.md", "V9-DOC-DATA-050", "V9-DOC-QA-046"]
related_skills: [v9-bash-conventions, v9-collection-pipeline-testing, v9-data-flow-integrity-audit, v9-doc-encoding-remediation]
freshness_policy:
  review_cycle: quarterly
  trigger_events: [pre-delivery, refactor, interface-change, rename]
search_priority: high
search_keywords: [模块同步, 同步校对, 交付检查, 代码先行, module-sync, sync-checklist]
---
