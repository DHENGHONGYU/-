# Tianyancha Kimi Plugin

This plugin bundles a Kimi skill and helper script for querying the Tianyancha
enterprise datasource through `agent-gw`.

## Contents

- `kimi.plugin.json`: catalog manifest for the Kimi plugin.
- `skills/tianyancha/SKILL.md`: model instructions for selecting and calling
  Tianyancha datasource APIs.
- `scripts/tianyancha_tool.py`: command-line wrapper around
...
python3 scripts/tianyancha_tool.py call --api-name "<api name>" --params-json '{"keyword":"Moonshot AI"}'
```
