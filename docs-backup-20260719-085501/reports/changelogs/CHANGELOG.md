...
| 文件 | 变更内容 |
|------|---------|
| `docs/reports/changelogs/CHANGELOG.md` | 新增 v2.7.0 条目，记录七阶段完整变更 |
| `docs/00-meta/development-log.md` | 更新开发日志，记录各阶段实现细节与问题解决方案 |
| `docs/explanation/03-architecture-standards.md` | 更新版本号至 v2.7.0，补充新增模块说明 |
| `docs/explanation/10-glossary.md` | 更新版本号至 v2.7.0 |
...
| `docs/00-meta/directory-structure-guide.md` | 修复 `src/schema/` → `src/data/schemas/`；版本 v3.1.0→v3.1.1 |
| `docs/00-meta/src-directories-evaluation-report.md` | 修复 `src/hooks/` → `src/hooks/` |
| `docs/reports/retrospectives/mcp-disabled-server-deep-dive.md` | 修复 `src/services/export/` → `src/services/export/` |
| `docs/00-meta/doc-manifest.csv` | 重新生成，594 条记录（核心 71 / 重要 300 / 参考 223） |
| `docs/00-meta/registry-index.md` | 从 doc-manifest.csv 重建，修复重复 frontmatter |
...
| 文件 | 变更内容 |
|------|---------|
| `docs/00-meta/doc-manifest.csv` | 全量重建，同步最新 docs/ 目录状态 |
| `docs/00-meta/registry-index.md` | 从 CSV 重建，消除重复 frontmatter |
...
| `scripts/fix-basename-root-refs.ts` | 新增：自动修复文档中对根文档（AGENTS.md / README.md / CHANGELOG.md）的 basename 断裂引用 |
| `src/pages/command/agent/LlmManagement/components/LlmConfigTab.tsx` | 删除未导入的 `Key as _KeyIcon` 导出，修复 `tsc:prod` 错误 |
| `docs/00-meta/doc-manifest.csv` | 重新生成，595 条记录（核心 71 / 重要 302 / 参考 222） |
| `docs/00-meta/registry-index.md` | 从 CSV 重建 |
| `docs/00-meta/development-log.md` | 新增 Phase 9 记录，修复重复 frontmatter |
| `docs/reports/changelogs/CHANGELOG.md` | 新增 Phase 9 记录，修复重复 frontmatter |
...
| `scripts/audit-hardcode.ts` | 扩展 COLOR_EXEMPT_FILES 集合，新增 theme.tokens 子模块豁免 |
...
| 文件 | 变更内容 |
|------|---------|
| `../../reference/data-dictionary-index.md` | v1.5.0→v1.6.0：新增混合校对模块索引，包含 17 个类型定义 |
| `../../reference/03-architecture-standards.md` | v2.5.0→v2.6.0：新增 §3.1.9 Hybrid Proofread 模块说明 |
| `../../reference/05-engine-specs.md` | v2.5.0→v2.6.0：新增混合校对引擎说明 |
...
| `../../reference/03-architecture-standards.md` | v2.3.0→v2.5.0：配置层新增 3 文件、服务层新增 3 个交易计算模块+2 个 UseCase、注册体系更新 |
| `../../reference/data-dictionary-index.md` | v1.3.0→v1.4.0：新增 UseCase 类型索引、交易计算纯函数类型索引 |
| `../../reference/05-engine-specs.md` | v2.2.1→v2.5.0：交易引擎目录新增 positionComputer/pnlComputer/riskComputer、新增 UseCase 层说明 |
...
| 文件 | 变更内容 |
|------|---------|
| `../../reference/registry-index.md` | 新建：四层注册体系核心文档 |
| `../../reference/03-architecture-standards.md` | v2.2.1→v2.3.0：新增 §3.1.8 四层模块注册体系、Widget 目录 +7、偏差 D19 标记已修复 |
| `../../reference/widget-development-guide.md` | v1.0.0→v1.1.0：新增 §7 已注册 Widget 清单（19 个）、§7.3 Widget 错误隔离说明 |
| `../../reference/testing-strategy.md` | v1.0.0→v1.1.0：新增 §9 注册体系测试策略、更新测试基线（649+ 用例）、Widget 错误边界测试模板 |
| `../../reference/data-dictionary-index.md` | v1.2.0→v1.3.0：新增 Registry 模块索引、3 个注册表类型文件条目 |
| `../../reference/10-glossary.md` | v2.2.1→v2.3.0：新增 §10.11 四层注册体系术语（8 条） |
| `../../reference/changelogs/2026-07/2026-07-05-module-registry-and-integration.md` | 新建：结构化变更日志 |
...
| `../../reference/03-architecture-standards.md` | P0/P1/P2 修正 | DB_VERSION 14 → 21、Store 清单 19 → 25 个、Widget 数量 12 → 21、技术栈 Pinia → Zustand、版本号 v1.1.0 → v2.2.1、偏差清单 D13/D14/D16 状态修正（?? → ??）、UnifiedStockData 状态修正（?? → ?）、Widget 引擎接入状态修正（?? → ?） |
| `../audit/quality-audit-plan.md` | P1 修正 | 技术栈 Pinia → Zustand、路由 26 → 47、Store 7 → 44、Widget 12 → 21 |
| `docs/README.md` | P2 修正 | 版本号 v0.9.0-migration-implemented → v2.2.1、更新日期 2026-06-24 → 2026-07-05 |
| `../../reference/01-vision-and-goals.md` | P2 修正 | 版本号 v0.9.0-migration-implemented → v2.2.1、更新日期 2026-06-25 → 2026-07-05 |
| `../../reference/02-functional-specs.md` | P2 修正 | 版本号 v1.1.0 → v2.2.1、更新日期 2026-06-26 → 2026-07-05 |
| `../../reference/04-ui-ux-specs.md` | P2 修正 | 版本号 v0.9.0-migration-implemented → v2.2.1、更新日期 2026-06-25 → 2026-07-05 |
| `../../reference/05-engine-specs.md` | P2 修正 | 版本号 v1.1.0 → v2.2.1、更新日期 2026-06-26 → 2026-07-05 |
| `../../reference/06-routing-specs.md` | P2 修正 | 版本号 v1.2.0 → v2.2.1、更新日期 2026-07-04 → 2026-07-05 |
| `../../reference/07-operation-strategy.md` | P2 修正 | 版本号 v0.9.0-migration-implemented → v2.2.1、更新日期 2026-06-25 → 2026-07-05 |
| `../../reference/08-implementation-plan.md` | P2 修正 | 版本号 v1.1.0 → v2.2.1、更新日期 2026-06-26 → 2026-07-05 |
| `../../reference/09-quality-gates.md` | P2 修正 | 版本号 v1.2.0 → v2.2.1、更新日期 2026-06-29 → 2026-07-05 |
| `../../reference/10-glossary.md` | P2 修正 | 版本号 v0.9.0-migration-implemented → v2.2.1、更新日期 2026-06-25 → 2026-07-05 |
...
1. **技术栈描述修正**
   - `../../reference/03-architecture-standards.md` 和 `../audit/quality-audit-plan.md` 中 Pinia → Zustand
...
5. **数量修正**
   ...
   - `../../reference/03-architecture-standards.md`：Widget 12 → 21
...
| `../../reference/03-architecture-standards.md` | 待修正 | DB_VERSION 14 → 21、Store 清单补充 6 个、技术栈 Pinia → Zustand |
...
1. **P0 问题修正**（待人工确认后执行）
   - 更新 `../../reference/03-architecture-standards.md` DB_VERSION 14 → 21
...
### F2 文档版本校正
- `../../reference/action-list.md` 升级至 v2.0.0，修正批次 A/B/C 虚假完成记录
...
| `../../reference/feedback-loop-spec.md` | 反馈闭环规格文档更新 |
...
| 文件 | 变更类型 | 变更内容 |
|------|---------|---------|
| `../../reference/03-architecture-standards.md` | 修正 | §3.1.2 DataFlow 补充 4 接口（DataFlowModuleInput/Output, DataPacket, ChannelMeta） |
| `../../reference/03-architecture-standards.md` | 新增 | §3.1.7 Page 生命周期（PageModuleInput/Output, PageGuard） |
| `../../reference/03-architecture-standards.md` | 修正 | §3.8 DataBridge 适配层补充 5 接口（DataBridgeAdapterConfig, DataAction, BridgeQueryOptions, BridgeQueryResult, DataBridgeAdapterStats） |
| `../../reference/03-architecture-standards.md` | 修正 | §3.7 数据层补充 34 个数据模型引用（DimensionScore, PortfolioHolding, StrategyClassification 等） |
| `../../reference/02-functional-specs.md` | 版本升级 | v0.9.1 → v1.1.0 |
| `../../reference/05-engine-specs.md` | 版本升级 | v0.9.0 → v1.1.0 |
| `../../reference/06-routing-specs.md` | 版本升级 | v0.9.0 → v1.1.0 |
| `../../reference/08-implementation-plan.md` | 版本升级 | v0.9.0 → v1.1.0 |
| `../../reference/09-quality-gates.md` | 版本升级 | v0.9.0 → v1.1.0 |

### 数据字典变更

| 文件 | 变更类型 | 变更内容 |
|------|---------|---------|
| `../../reference/api-contract.md` | 修正 | §9.2b 新增 TradeSignal/TradingSignal 接口定义（8 字段 + SignalSnapshot 子类型） |
| `../../reference/data-definition.md` | 元数据 | 添加版本头部（Version: v1.1.0, Last Updated: 2026-06-26） |
| `../../reference/ai-center-data-definition.md` | 元数据 | 添加版本头部（Version: v1.1.0, Last Updated: 2026-06-26） |
| `../../reference/api-contract.md` | 元数据 | 添加版本头部（Version: v1.1.0, Last Updated: 2026-06-26） |
| `../../reference/data-definition.md` | 元数据 | 添加版本头部（Version: v1.1.0, Last Updated: 2026-06-26） |
| `../../reference/data-definition.md` | 元数据 | 添加版本头部（Version: v1.1.0, Last Updated: 2026-06-26） |
| `../../reference/data-dictionary-index.md` | 版本升级 | v0.9.0 → v1.1.0 |
| `../../reference/dataflow-data-definition.md` | 版本升级 | v0.9.0 → v1.1.0 |
...
| `../../reference/v9-architecture-data-dictionary-validation-report.md` | 一致性验证报告 |
| `./CHANGELOG.md` | 本文档 |
...
| Cockpit | `../../reference/03-architecture-standards.md` §3.1.4 | 目录结构替换为 12 个实际 Widget，新增 §3.1.4.1 采集流 |
| News | `../../reference/data-definition.md` | 新建，newsService/sentimentAnalyzer/stockLinker 5 接口 |
| News | `../../reference/02-functional-specs.md` §2.1 | 新增新闻资讯模块 |
| Trading | `../../reference/api-contract.md` §9 | 新增交易服务层 9 接口 + 7 模块函数清单 |
| Trading | `../../reference/02-functional-specs.md` §2.1 | 新增交易持仓管理模块 |
| AI Center | `../../reference/ai-center-data-definition.md` §5 | 补充 Agent 运行时类型（AgentModuleInput/Output, AgentDefinition, AgentInstance） |
| AI Center | `../../reference/02-functional-specs.md` §2.1 | 新增 AI 智能体中心模块 |
...
| Architecture | `../../reference/03-architecture-standards.md` | L5/L4 映射表补充 Widget 数量，L3 行补充 news 服务路径 |
| User Stories | `../../reference/02-functional-specs.md` §2.4 | 新增 3 个用户故事（2.4.12~2.4.14） |
...
| 编号 | 文档 | 说明 |
|------|------|------|
| 01 | `../../reference/01-vision-and-goals.md` | 愿景与目标 |
| 02 | `../../reference/02-functional-specs.md` | 功能规格 |
| 03 | `../../explanation/03-architecture-standards.md` | 架构标准 |
| 04 | `../../reference/04-ui-ux-specs.md` | UI/UX 规格 |
| 05 | `../../explanation` | 引擎规格 |
| 06 | `../../reference/06-routing-specs.md` | 路由规格 |
| 07 | `../../reference/07-operation-strategy.md` | 运营策略 |
| 08 | `../../explanation/design/08-implementation-plan.md` | 实施计划 |
| 09 | `../../reference/09-quality-gates.md` | 质量门禁 |
| 10 | `../../explanation/10-glossary.md` | 术语表 |
