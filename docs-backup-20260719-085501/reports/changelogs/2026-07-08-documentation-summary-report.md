...
| # | 文件路径 | 修改内容 |
|---|---------|---------|
| 6 | `../reference/data-dictionary-index.md` | 添加 10 个模块索引条目：Store 派生计算、事件订阅、全局错误处理、UI 基础组件、派生缓存工具、本地存储加密、错误总线、韧性工具、确认对话框 Hook、板块常量、风控派生计算、V6 评分引擎 L3 辅助函数 |
| 7 | `../reference/03-architecture-standards.md` | 新增 §3.1.10 Store 派生计算与事件订阅（含设计原则、缓存策略、导出模式、文件清单）、§3.5.1 V6 评分引擎 L3 层辅助函数（含评分规则说明） |
...
| 本次更新文档 | 3（data-dictionary-index.md、03-architecture-standards.md、CHANGELOG.md） |
| 代码注释补充文件 | 5 |
