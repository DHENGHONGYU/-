...
summary: "quality-audit-plan - reports documentation (qa)"
tags: [qa, quality, audit, report, plan]
version: v1.1.0
...
|:---|:---|
| 项目名称 | 智能投研复盘系统 V9 |
| 技术栈 | React 19 + TypeScript + Vite + Zustand + Tailwind |
...
| 编号 | 功能入口 | 路由 | 对应组件 |
|:---|:---|:---|:---|
| B1 | 输入舱 Hub | `/input/hub` | `src/apps/input/InputApp.tsx` |
...
| 编号 | 功能入口 | 路由 | 对应组件 |
|:---|:---|:---|:---|
| C1 | 分析舱 Hub | `/analysis/hub` | `src/apps/analysis/AnalysisApp.tsx` |
...
| C9 | 热门板块策略 | `/analysis/hot-sector-strategy` | `src/pages/analysis/HotSectorPage.tsx` |
...
| 编号 | 功能入口 | 路由 | 对应组件 |
|:---|:---|:---|:---|
| D1 | 交易舱 Hub | `/trading/hub` | `src/apps/trading/TradingApp.tsx` |
...
| 编号 | 功能入口 | 路由 | 对应组件 |
|:---|:---|:---|:---|
| E2 | 总控舱 Hub | `/command/hub` | `src/apps/command/CommandApp.tsx` |
...
| 序号 | 交付物 | 路径 | 说明 |
|:---|:---|:---|:---|
| 1 | 执行计划 | `./quality-audit-plan.md` | 本文档 |
| 2 | 完成度剖面图 | `../../reference/completeness-profile.md` | 所有模块的五层剖面图汇总 |
| 3 | 修复行动清单 | `../../reference/action-list.md` | 按 P0/P1/P2 排序的修复建议 |
...
> 详细结果见 `../../reference/completeness-profile.md`（完成度剖面图）和 `../../reference/action-list.md`（修复行动清单）
