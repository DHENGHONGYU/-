...
> **测试文件**: [tests/__tests__/integration/walkthroughScoreDoc.sampled.test.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/tests/__tests__/integration/walkthroughScoreDoc.sampled.test.ts)
...
依据 [scoreDocService.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/src/services/analysis/scoreDocService.ts) 中的 `buildChangeFromPrev` 纯函数:
...
在 [scoreDocService.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/src/services/analysis/scoreDocService.ts) 中新增 `ScoreDocDiff` 接口与 `buildScoreDocDiff` 函数,与现有 `buildChangeFromPrev` 的区别:本函数额外提供新增/删除维度、评级变化信息。
...
| # | 问题 | 位置 | 严重度 | 状态 | 修复内容 |
|---|------|------|--------|------|----------|
| 1 | `getFileLibraryStats` 中 `composite >= 4.0` 硬编码 | [scoreDocService.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/src/services/analysis/scoreDocService.ts) | 中 | ✅ **已修复** | 改为引用 `DEFAULT_THRESHOLDS.rating.strongBuy` |
| 2 | `buildScoreDocDiff` 函数与 `ScoreDocDiff` 类型缺失 | [scoreDocService.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/src/services/analysis/scoreDocService.ts) | 高 | ✅ **已修复** | 新增函数与类型,修复 ScoreHistoryPanel.tsx 与测试的引用错误 |
...
| 文件 | 用途 | 状态 |
|------|------|------|
| [tests/__tests__/integration/walkthroughScoreDoc.sampled.test.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/tests/__tests__/integration/walkthroughScoreDoc.sampled.test.ts) | 本次穿行测试文件 | ✅ 已创建并通过 |
| [src/services/analysis/scoreDocService.ts](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/src/services/analysis/scoreDocService.ts) | 被测核心服务 | ✅ 已修复(P1 + buildScoreDocDiff) |
...
| [src/components/analysis/score/ScoreHistoryPanel.tsx](file:///c:/Users/huawei/Documents/kimi/Workspaces/智能投研复盘系统V9/src/components/analysis/score/ScoreHistoryPanel.tsx) | 历史面板组件 | ✅ 引用错误已消除(无需修改) |
