...
const EXPECTED_PATHS: Record<string, { path: string; label: string }[]> = {
  input: [
    ...
    { path: '/input/data-test', label: '采集测试（已合并至采集监控台）' },
    { path: '/input/collection-monitor', label: '采集监控台' },
    { path: '/input/collection-strategy', label: '采集策略配置' },
    { path: '/input/local-knowledge', label: '本地知识库' },
    { path: '/input/collect-tasks', label: '采集任务监控（已合并至采集监控台）' },
    { path: '/input/pool-board', label: '股票池看板（候选池管理）' },
    { path: '/input/seven-dim', label: '七维采集策略配置（已合并至采集策略配置）' },
    { path: '/input/fetcher-config', label: '抓取引擎配置（已合并至采集策略配置）' },
  ],
  analysis: [
  ...
  output: [
    ...
    { path: '/output/chip-strategy', label: '筹码策略复盘' },
  ],
  command: [
    ...
    { path: '/command/agents/task-panel', label: '任务管理（合并）' },
    { path: '/command/agents/model-config', label: '模型配置（合并）' },
    { path: '/command/agents/optimization-panel', label: '优化建议（合并）' },
    { path: '/command/agents/changelog', label: '更新日志' },
    { path: '/command/mcp-servers', label: 'MCP Server 管理' },
    { path: '/command/monitor', label: '系统监控' },
    { path: '/command/system-health', label: '系统健康（合并）' },
