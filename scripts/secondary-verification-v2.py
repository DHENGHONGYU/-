...
def verify_cross_references(docs_root):
    ...
    for rel_path in all_files:
        if 'deprecated-docs' in rel_path or 'old-versions' in rel_path:
            continue
        ...
        for filename in files:
            ...
            try:
                ...
                for imp in relative_imports:
                    if 'xxxStore' in imp or '{' in imp or 'm' == imp or 'n' == imp:
                        continue
