...
garbled_mappings = {
    ...
    'b批次高价值孤儿集成状态报': 'docs/explanation/b批次高价值孤儿集成状态报告-2026-07-08.md',
    'åå¸è®¡åä¸è¯å®': 'docs/explanation/design/发布计划与评审-r01.md',
    '发布计划与评': 'docs/explanation/design/发布计划与评审-r01.md',
    'åæ»æ¹æ¡ä¸æ¼ç»': 'docs/explanation/design/回滚方案与演练-r03.md',
    '回滚方案与演': 'docs/explanation/design/回滚方案与演练-r03.md',
    ...
    'v9-ä½ç³»åä¸çº¿æµè¯': 'docs/_pending-review/v9-体系化上线测试-todo-list.md',
    'v9ݼܹ޶': 'docs/_pending-review/v9-体系化上线测试-todo-list.md'
}
    ...
    def replace_link(match):
        ...
        for garbled, correct_path in garbled_mappings.items():
            if garbled in raw_link:
                new_link = raw_link.replace(garbled, correct_path)
