...
describe('rotationScoreService', () => {
  ...
  it('应该calculate sector score from sub scores', () => {
    const scores = {
  ...
  it('应该reject invalid sub scores', async () => {
    const result = await saveRotationScore({
      sectorCode: 'AI',
      sectorName: '人工智能',
      scoreDate: '2026-06-24',
  ...
  it('应该保存 default rotation scores for all sector definitions', async () => {
