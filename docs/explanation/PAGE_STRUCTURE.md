...
> **Related**: `src/pages/`、`src/config/routes.ts`、`docs/02-design/06-routing-specs.md`

---

## 1. 定位

V9 前端采用**五舱（cabin）架构**，页面统一置于 `src/pages/<cabin>/`，路由定义集中于 `src/config/routes.ts`（详见 `docs/02-design/06-routing-specs.md`）。各舱室规格见 `docs/02-design/*-cabin-spec.md`。
...
| 舱室 | 规格文档 |
|------|---------|
| 输入舱 | `docs/02-design/input-cabin-spec.md` |
| 分析舱 | `docs/02-design/analysis-cabin-spec.md` |
| 交易舱 | `docs/02-design/trading-cabin-spec.md` |
| 输出舱 | `docs/02-design/output-cabin-spec.md` |
| 指挥舱 | `docs/02-design/command-cabin-spec.md` |
...
| 动作 | 文档 |
|------|------|
| 主更新动作 | 本文档（`docs/02-design/PAGE_STRUCTURE.md`） |
| 补充文档 | `docs/02-design/06-routing-specs.md` |
