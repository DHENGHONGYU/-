...
tags: [project, plan, log, explanation, governance, documentation, strategy]
version: v1.0.0
last_updated: 2026-07-17
code_version: 2.0.0
doc_id: V9-DOC-PROJ-063
change_log:
  - version: v1.0.0
...
> ⚠️ **本文档已过时�?026-07-12 标注，N5 模式�?*：本清单�?2026-07-04 快照。关键项已处置：
> - "549 �?TS 编译错误" �?现仅 **9 �?*（全�?`src/services/trading/riskEngine.ts`，见 `./design/tech-debt.md` TD-007）；
> - "Pre-commit hook 失效" �?已修复（Husky 12 道门禁全绿）�?> - "git config 未设�? �?需另行核实�?>
