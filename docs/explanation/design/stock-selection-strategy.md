...
tags: [backend, strategy, screening, design, documentation]
version: v1.0.0
...
| 分类 | 标识 | 优先�?| 核心逻辑 | 详细文档 |
|------|------|--------|----------|----------|
| 核心稀缺资�?| `core-scarce` | 第一梯队 | 匹配主题 + 综合分达�?| [core-scarce-strategy.md](./core-scarce-strategy.md) |
| 热门赛道 | `hot-momentum` | 第二梯队 | 板块热门 + 动量达标 | [hot-momentum-strategy.md](./hot-momentum-strategy.md) |
| 价值洼�?| `value-bargain` | 第二梯队 | 估值分�?+ 综合分适中 | [value-bargain-strategy.md](./value-bargain-strategy.md) |
| 观察�?| `watchlist` | 第三梯队 | 暂不参与交易，持续跟�?| [watchlist-strategy.md](./watchlist-strategy.md) |
