---
title: Cockpit & News 模块文档修正方案（Phase 2-3）
type: explanation
domain: frontend
phase: design
tier: standard
...
> **关联差异报告**: `./v9-architecture-data-diff-report.md`  
...
|------|------|----------|-----------|--------|
| 1 | 新建 | `../../reference/data-definition.md` | DIFF-007, DIFF-008 | ?? P0 |
| 2 | 新建 | `../../reference/data-definition.md` | DIFF-014 | ?? P0 |
| 3 | 修改 | `../../reference/03-architecture-standards.md` | DIFF-001, DIFF-004 | ?? P0 |
| 4 | 修改 | `../../reference/02-functional-specs.md` | DIFF-004 | ?? P0 |
| 5 | 修改 | `docs/README.md` | DIFF-006 | ?? P0 |
| 6 | 修改 | `../../reference/10-glossary.md` | DIFF-019, DIFF-022 | ?? P1 |

---

## 二、新建文件修正内容

### 2.1 `../../reference/data-definition.md`（新建）
