...
1. 运行 `npm run audit`。
2. 将结果填入 `../../reference/09-quality-gates.md` 第 7 节「当前扫描基线」。
...
2. **PR 检查清单**：每个 PR 必须勾选：
   ...
   - [ ] 路由变更已同步到 `../../reference/06-routing-specs.md`。
   - [ ] schema 变更已同步到 `../../reference/03-architecture-standards.md`。
   - [ ] 新增用户故事已同步到 `../../reference/02-functional-specs.md`。
