...
referenced_by: [V9-DOC-PROJ-174, V9-DOC-META-000, V9-DOC-PROD-006, V9-DOC-PROJ-176, V9-DOC-PROJ-182, V9-DOC-PROJ-243, docs/00-meta/deprecated-docs/old-versions/registry-index-v1.0.0-02-design.md, V9-DOC-PROJ-149]
change_log:
  - version: v1.0.0
...
- [09-quality-gates.md](09-quality-gates.md) ?? ????????
