...
summary: "归并来源：`./deprecated-batch1-merge-report.md` + `../deprecated-batch2-merge-report.md` +..."
...
> 归并来源：`./deprecated-batch1-merge-report.md` + `../deprecated-batch2-merge-report.md` + `./deprecated-batch3-merge-report.md`  
> 归并日期：2026-06-27  
...
| `./implementation-governance.md` | 修改 | Doc-Sync | ? | lint ? / build ? |
