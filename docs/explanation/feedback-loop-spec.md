...
> **????????**??`../reference/v9-system-blueprint.md` ??5.3 ????????????????7.2 UI/UX ????????????10 ?????? D18??????????????????????
> **????????**??`../reference/04-ui-ux-specs.md`??Toast ????????????`../reference/widget-error-handling.md`??????????????????????????????

---

## 1. ??????????

?????????? V9 ?????????????????????????????????? Toast ?????????????????????????? `FeedbackService`???????????????????????? `EventBus` ???????????????????????????????? Widget ???????????????? `../reference/chart-integration.md` ?? `../reference/widget-error-handling.md`????
...
Widget ???????????????????????????????????????? Toast?????????? `feedbackService.notify()` ???? `error` ???????? `ToastProvider` ?????????????? `../reference/widget-error-handling.md` ??4.2??
...
- `../reference/04-ui-ux-specs.md` ??4.6 ????????
- `../reference/chart-integration.md` ??5.2????????????????????
- `../reference/widget-error-handling.md` ??4.2??????????????????????
