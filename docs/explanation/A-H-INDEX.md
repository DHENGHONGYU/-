...
### [B] 架构设计
- [架构概览](explanation/overview.md)
- [子系统架构（ARCHITECTURE.md）](explanation/ARCHITECTURE.md)
- [舱室总览](explanation/cabins-overview.md)
...
- [数据定义](reference/DATA_DEFINITION.md)
- [数据字典索引](reference/DATA_DICTIONARY_INDEX.md)
- [各类业务数据定义](02-design/standards/)（`*-data-definition.md`）

### [D] 技术规范
- [编码规范](reference/coding-conventions.md)
- [JSDoc 规范](explanation/jsdoc-convention.md)
- [复杂度治理](explanation/complexity-governance.md)
...
- [草稿](reports/drafts/)
- [发布管理](reports/release-management/)、([发布说明](reference/RELEASE_NOTES.md))
...
- [PR 说明模板](reference/PR_DESCRIPTION.md)
