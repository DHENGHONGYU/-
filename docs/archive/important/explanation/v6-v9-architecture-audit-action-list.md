...
| 编号 | 问题描述 | 文件路径 | 影响 | 建议修复方式 | 批次 |
|:---|:---|:---|:---|:---|:---|
| P2-01 | 路由规格文档 `06-routing-specs.md` 与实际 `routes.ts` 不同步（29 vs 35 条） | `06-routing-specs.md` | 文档失效，新开发者易产生误解 | 按 `routes.ts` 实际 35 条路由更新文档 | D |
...
| P2-15 | `06-routing-specs.md` 已声明“子页面未拆分”为已知偏差，但未明确是否接受 | `06-routing-specs.md` | 规格模糊 | 在文档中明确标注 accepted deviation 及原因 | D |
