...
> **关联文档**：
> - [测试策略总览](../../guides/testing-strategy.md) — 三层测试策略与改进路线
> - [LLM API Key 真实调用测试整体方案](llm-api-key-realtime-test-plan.md) — 真实 Key 验证 LLM 密钥安全与调用链路（V9-DOC-QA-122）
> - [AGENTS.md](../../meta/AGENTS.md) — 四步集成回滚验证、事件监听清理模板
...
# 手动更新 docs/specs/design/06-routing-specs.md 或 DATA_DICTIONARY_INDEX.md
...
- [三层测试策略](../../guides/testing-strategy.md)
- [AGENTS.md §二 — 四步集成与回滚验证](../../meta/AGENTS.md)
- [AGENTS.md §三 — 事件监听清理模板](../../meta/AGENTS.md)
- [AGENTS.md §七 — 验证命令速查](../../meta/AGENTS.md)
