...
summary: "## 背景 V9 当前已通过 ADR-008 引入「第四次工业革命稀缺核心资源」主题策略，并在 `src/services/trading/strategyEngine.ts` 中实现..."
...
1. 更新 `../explanation/03-architecture-standards.md`、`../explanation/05-engine-specs.md`、`../reference/10-glossary.md`；
2. 新增单元测试与集成测试；
...
- [ ] 更新 `../explanation/03-architecture-standards.md`、`../explanation/05-engine-specs.md`、`../reference/10-glossary.md`
- [ ] 新增测试并确保质量门禁通过
