...
> **Related**: `src/pages/`、`src/config/routes.ts`、`06-routing-specs.md`

---

## 1. 定位

V9 前端采用**五舱（cabin）架构**，页面统一置于 `src/pages/<cabin>/`，路由定义集中于 `src/config/routes.ts`（详见 `06-routing-specs.md`）。各舱室规格见 `docs/specs/design/*-cabin-spec.md`。
