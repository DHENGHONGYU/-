...
> **校对日期**: 2026-07-09
> **校对对象**: `src/components/input/CollectionPlanPanel.tsx`
> **V6 设计基准**: `docs/implementation/data-collection-route-ui-audit.md` 第3节
...
根据 `data-collection-route-ui-audit.md` 第3.1节，V6 采集方案整合面板包含以下功能模块：
...
| 8维度频率配置表 | ⚠️ 部分实现 | L72-L88, L171-L201 | 仅展示频率、批次、数据源，缺少存储策略/重要性/字段 |
...
**文件路径**：`src/components/input/ApiTestDialog.tsx`（已创建框架）
...
**文件路径**：`src/components/input/QuotaEstimatePanel.tsx`（待创建）
...
**修改文件**：`src/components/input/CollectionPlanPanel.tsx`
