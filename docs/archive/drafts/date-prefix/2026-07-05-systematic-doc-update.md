...
|------|------|-----------|-----------|----------|
| 1 | `../../data-definition.md` | v1.1.0 | v1.2.0 | 字段补充 + Widget 注册表扩展 |
| 2 | `../../ai-center-data-definition.md` | v1.1.0 | v1.2.0 | 9 个 Agent 运行时类型补充 |
...
| 5 | `../../../explanation/06-routing-specs.md` | v3.0.0 | v3.1.0 | 数量统计修正（47→48） |
