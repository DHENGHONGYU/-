...
| **T3 架构调整** | `src/config/routes.ts`<br>`src/config/dbConfig.ts`<br>`../../meta/AGENTS.md` | `../../explanation/03-architecture-standards.md`<br>`../../explanation/06-routing-specs.md`<br>`../../explanation/03-architecture-standards.md` |
