...
| 触发器 | 监控路径 | 需要更新的文档 |
|--------|---------|---------------|
| **T1 类型定义变更** | `src/data/types.ts`<br>`src/types/modules/*.ts`<br>`src/services/scoring/v6-engine/types.ts` | `./data-dictionary-index.md`<br>`./v9核心数据字典与类型定义(整合版).md` |
| **T2 接口变更** | `src/services/**/index.ts`<br>`src/core/databridge.ts`<br>`src/data/dataLayer.ts` | `./api-contract.md`<br>`./databridge端点与数据映射清单.md` |
| **T3 架构调整** | `src/config/routes.ts`<br>`src/config/dbConfig.ts`<br>`../../AGENTS.md` | `../explanation/03-architecture-standards.md`<br>`../explanation/06-routing-specs.md`<br>`../explanation/03-architecture-standards.md` |
| **T4 配置参数变更** | `src/constants/*.ts`<br>`src/config/thresholds.ts`<br>`src/services/scoring/v6-engine/config.ts` | `../explanation/05-engine-specs.md`<br>`../guides/09-quality-gates.md` |
...
- [AI 行为约束契约](../../../meta/AGENTS.md)
- [质量门禁](../../../guides/09-quality-gates.md)
