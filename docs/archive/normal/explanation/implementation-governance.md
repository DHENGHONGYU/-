...
1. 运行 `npm run audit`。
2. 将结果填入 `../../guides/09-quality-gates.md` 第 7 节「当前扫描基线」。
...
2. **PR 检查清单**：每个 PR 必须勾选：
   ...
   - [ ] 路由变更已同步到 `../06-routing-specs.md`。
   - [ ] schema 变更已同步到 `../03-architecture-standards.md`。
   - [ ] 新增用户故事已同步到 `../../specs/02-functional-specs.md`。
