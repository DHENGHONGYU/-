...
| [data-interaction-protocols.md](../implementation/data-interaction-protocols.md) | 2026-06-25 | 89 | `src/core/databridge.ts` | 数据交互协议与 DataBridge 端点 |
...
| 文档 | 最后更新 | 行数 | 关联代码目录 | 说明 |
|:---|:---|:---|:---|:---|
| [agent-runtime-spec.md](../implementation/agent-runtime-spec.md) | 2026-06-25 | 107 | `src/types/modules/agent.types.ts` | Agent Runtime 实现规格 |
| [dataflow-engine-spec.md](../implementation/dataflow-engine-spec.md) | 2026-06-25 | 116 | `src/core/dataflow/` | DataFlow Engine 实现规格 |
| [rotation-score-spec.md](../implementation/rotation-score-spec.md) | 2026-06-25 | 146 | `src/services/rotation-score/` | Rotation Score Service 实现规格 |
...
| 文档 | 最后更新 | 行数 | 关联代码目录 | 说明 |
|:---|:---|:---|:---|:---|
| [v9-architecture-data-diff-report.md](<宸插綊妗?) | 2026-06-27 | 207 | `docs/`, `src/` (全量) | 架构资产差异分析报告 |
...
| [v9-documentation-audit-report.md](<宸插綊妗?) | 2026-06-25 | 246 | `docs/` (全量) | 文档体系化审计与补全建议 |
| [v9-current-state-review.md](<宸插綊妗?) | 2026-06-25 | 322 | `src/` (全量) | 当前状态全面梳理（按实施进度） |
| [implementation-governance.md](implementation-governance.md) | 2026-06-25 | 111 | `docs/`, `src/` | 实施治理与架构决策记录 |
| [quality-gates-baseline.md](../implementation/quality-gates-baseline.md) | 2026-06-25 | 75 | `scripts/` | 质量门禁实测基线 |
...
| [doc-sync-execution-plan.md](<宸插綊妗?) | 2026-06-26 | 152 | `docs/` | 代码-文档同步整体方案与执行计划 |
...
| 文档 | 最后更新 | 行数 | 说明 |
|:---|:---|:---|:---|
| [batch-merge-reports.md](<宸插綊妗?) | 2026-06-27 | 135 | Batch 1-3 阶段性合并报告汇总 |
...
| [adr/2026-06-21-databridge-over-direct-datalayer.md](../implementation/adr/2026-06-21-databridge-over-direct-datalayer.md) | 2026-06-24 | 20 | ADR-003: DataBridge 替代直接 dataLayer |
...
| [adr/2026-06-24-pool-screening-signal-persistence-review-engine.md](../2026-06-24-pool-screening-signal-persistence-review-engine.md) | 2026-06-24 | 32 | ADR-007: 补齐筛选/信号/复盘引擎 |
...
| [deprecated/DEPRECATED_v9-issue-execution-board.md](<宸插綊妗?) | 2026-06-27 | 合并至 v9-issue-management.md |
...
| [deprecated/DEPRECATED_v9-parallel-task-schedule.md](<宸插綊妗?) | 2026-06-27 | 合并至 v9-issue-management.md |
...
| 3 | 废弃文档 | [deprecated/](<宸插綊妗?) | 存放 9 份已废弃的旧文档 |
| 4 | 健康度报告 | [health-report.md](../../reports/health-report.md) | 每份文档的保鲜度评分与标签 |
| 5 | 时间轴报告 | [timeline-report.md](<宸插綊妗?) | 变更历史时间线 + 沉默期分析 |
