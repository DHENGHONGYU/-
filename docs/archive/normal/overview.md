...
- 文档：`06-routing-specs.md`、`../specs/04-ui-ux-specs.md`、`../guides/08-implementation-plan.md`、`../reference/stock-pool-board-migration-proposal.md`
...
- 同步文档：`docs/reference/atomic-component-system.md`（新建，含层级定义/目录/映射/迁移路径/门禁）、`../specs/04-ui-ux-specs.md`（4.5 组件库清单）、`../guides/08-implementation-plan.md`。
