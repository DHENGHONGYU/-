...
📢 基线更新：`docs/05-engine-specs.md`、`docs/06-routing-specs.md`、`docs/09-quality-gates.md`、`src/vite-env.d.ts` 及 6 个核心/实施文档 frontmatter 已修改至 V9-RC-1 版本，请各位 Agent 拉取最新上下文。
