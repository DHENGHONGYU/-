...
> **基于**: v9-architecture-data-diff-report.md（已归档）  
> **Version**: v1.0.0  
> **Date**: 2026-06-26  
...
|------|--------|---------|---------|---------|
| 1 | DIFF-001 | Cockpit/Widget 架构补充 | `../explanation/03-architecture-standards.md` §3.1.1, §3.1.4 | 修改 |
| 2 | DIFF-004 | News 模块架构 + 功能规格补充 | `../explanation/03-architecture-standards.md` §3.1.1, `../specs/02-functional-specs.md` §2.1 | 修改 |
...
| 8 | DIFF-020 | 功能模块总览补充 | `../specs/02-functional-specs.md` §2.1 | 修改 |
...
**目标文件**: `../explanation/03-architecture-standards.md`
...
**目标文件 A**: `../explanation/03-architecture-standards.md` §3.1.1
...
**目标文件 B**: `../specs/02-functional-specs.md` §2.1
...
**目标文件 B**: `../specs/02-functional-specs.md` §2.1（已在 2.2 中处理）
