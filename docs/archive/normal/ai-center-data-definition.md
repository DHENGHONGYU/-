...
change_log:
  - version: v1.2.1
    changes: "2026-08-15 系统性核对：与 src/constants/ai-center.constants.ts、src/types/modules/ai-center.types.ts 对齐，字段无漂移；登记为 design 阶段视图，权威 SSOT 转向 docs/reference/data-dictionary-index.md v1.1.0。"
    date: 2026-08-15
  - version: v1.2.0
