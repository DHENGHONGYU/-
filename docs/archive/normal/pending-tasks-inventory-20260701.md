...
来源：`../guides/08-implementation-plan.md` L154-164
...
来源：`../guides/08-implementation-plan.md` L170-176
...
来源：`../guides/08-implementation-plan.md` L182-187

| # | 任务描述 | 验证状态 | 说明 |
|---|---------|---------|------|
| 17 | 完整功能验收（对照 `../specs/02-functional-specs.md` 与 `../guides/09-quality-gates.md`） | 🟡 待执行 | 需要系统性验收流程 |
...
1. **`../guides/08-implementation-plan.md`**
