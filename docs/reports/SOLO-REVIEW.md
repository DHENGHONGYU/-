...
type: reference
domain: project
doc_id: V9-DOC-AUTO-CDFD3E
code_version: 2.0.0
summary: 问题: 单人开发没有同事审查代码，如何保证质量？
...
- [ ] **文档同步**: 如类型定义变更，确认 `docs/06-routing-specs.md` 或数据字典已更新
- [ ] **CHANGELOG 更新**: 确认 `CHANGELOG_reference.md` 已记录本次变更
- [ ] **测试覆盖**: 确认新增代码有对应单元测试
...
# 检查是否更新了 CHANGELOG
git diff --name-only
# 确认输出中包含 CHANGELOG_reference.md
...
- 下月改进计划（更新到 `CHANGELOG_reference.md` 或 Issue）
