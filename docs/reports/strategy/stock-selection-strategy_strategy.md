...
type: reference
domain: project
doc_id: V9-DOC-AUTO-1807D5
code_version: 2.0.0

summary: V9 选股策略体系由 四分类选股（strategyEngine） 与 双策略评分增强（dualStrategyEngine） 两个层次构成：
phase: maintenance
---
...
| 分类 | 标识 | 优先级 | 核心逻辑 | 详细文档 |
|------|------|--------|----------|----------|
| 核心稀缺资源 | `core-scarce` | 第一梯队 | 匹配主题 + 综合分达标 | [core-scarce-strategy_strategy.md](../../specs/architecture/core-scarce-strategy.md) |
| 热门赛道 | `hot-momentum` | 第二梯队 | 板块热门 + 动量达标 | [hot-momentum-strategy_strategy.md](../../specs/architecture/hot-momentum-strategy.md) |
| 价值洼地 | `value-bargain` | 第二梯队 | 估值分高 + 综合分适中 | [value-bargain-strategy_strategy.md](../../specs/architecture/value-bargain-strategy.md) |
| 观察仓 | `watchlist` | 第三梯队 | 暂不参与交易，持续跟踪 | [watchlist-strategy_strategy.md](../../specs/architecture/watchlist-strategy.md) |
...
- [核心稀缺资源策略](../../specs/architecture/core-scarce-strategy.md)
- [热门赛道策略](../../specs/architecture/hot-momentum-strategy.md)
- [价值洼地策略](../../specs/architecture/value-bargain-strategy.md)
- [观察仓策略](../../specs/architecture/watchlist-strategy.md)
- [架构文档](../../explanation/architecture/v9-strategy-architecture_architecture.md)
- [ADR-008: 第四次工业革命稀缺核心资源策略](../../reference/implementation/adr/2026-06-24-adopt-v6-core-resource-trading-strategy.md)
- [ADR-009: 双策略体系](../../reference/implementation/adr/2026-06-27-dual-strategy-system_adr.md)
- [引擎规格](../../specs/05-engine-specs.md)
- [架构标准](../../specs/03-architecture-standards.md)