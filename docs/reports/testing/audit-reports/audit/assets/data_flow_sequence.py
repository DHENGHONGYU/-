...
if __name__ == '__main__':
    ...
    # 1. 生成matplotlib时序图
    png_path = r'Users/<user>/.trae-cn\work\6a406ac459f8ecc595828aa8\data_flow_sequence.png'
    draw_sequence_diagram(png_path)
    
    # 2. 生成Mermaid时序图代码
    mmd_path = r'Users/<user>/.trae-cn\work\6a406ac459f8ecc595828aa8\sequence_diagram.mmd'
