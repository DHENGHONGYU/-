...
| `UI设计对照与成熟度评估_V6vsV9.html` | HTML | V6 vs V9 设计对照 | 2026-07-08 设计阶段 | 建议提取核心结论并入 `../../v6pro-v9-gap-analysis-final.md` |
| `智能投研复盘系统V9-整改计划表.xlsx` | XLSX | 整改任务排期表 | 2026-07-08 项目管理 | 建议核心任务转为 `docs/meta/` 下的 Markdown 执行计划 |

---

## 治理规则

- 本目录**不纳入 `docs/README_root.md` A–H 索引**（过程产物，非体系文档）。
- 新增计划文档优先使用 `.md` 格式；`.html`/`.xlsx` 保留期限：**6 个月**或任务完成后归档。
- 参照 `../../meta/governance.md` §4「保鲜优于堆积」：任务完成后，相关计划应提取结论并入体系文档，原始产物归档或删除。
