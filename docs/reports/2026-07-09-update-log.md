...
![V9 首页](v9-homepage-2026-07-09.png)
...
![分析舱](v9-analysis-cabin-2026-07-09.png)
...
| 6 | `src/components/installGlobalErrorHandler.ts` | 49 | ✅ 完整 | ✅ 已引用 |
| 7 | `src/components/ui/PageContainer.tsx` | 51 | ✅ 完整 | ✅ 已引用 |
| 8 | `src/components/ui/PageHeader.tsx` | 63 | ✅ 完整 | ✅ 已引用 |
...
### 3.2 文档引用更新
- `DATA_DICTIONARY_INDEX.md` — 添加 15 个模块索引（含完整路径）
- `03-architecture-standards.md` — 新增 §3.1.10 Store 派生计算与事件订阅
- `RISK_DERIVED_DATA_DEFINITION.md` — 新增风控派生数据详细文档
...
| PPT 大纲 | `docs/reports/2026-07-09-technical-sharing-ppt-outline.md` |
| 风控派生数据定义 | `docs/RISK_DERIVED_DATA_DEFINITION.md` |
| 数据字典索引 | `docs/DATA_DICTIONARY_INDEX.md` |
