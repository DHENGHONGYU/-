...
| 14 | 文档注册索引（Agent 条目） | `docs/meta/registry-index.md` | C-01/C-14/C-63/I-257/R-128 等 | 搜索 Agent 相关条目的索引工具 |
...
| 19 | 文档治理与修复行动计划（AI Agent 集群协同） | `docs/meta/prompt-execute-remediation.md` | C-63 / DAT | Agent 集群协同治理，属治理过程文档 |
...
- [ ] 将本索引表登记进 `docs/meta/registry-index.md`（新增 `scene#17` 维度或 `AGENT` 类目）
