...
| V9-DOC-DEV-009 | dev | 颜色令牌生命周期管理指南（入-移-出） | guides/how-to/COLOR-TOKEN-GUIDE.md |
| V9-DOC-DEV-010 | dev | V9 文件管理规范 | guides/how-to/FILE-MANAGEMENT-GUIDE.md |
| V9-DOC-DEV-011 | dev | 自定义 Hook 使用指南 | guides/how-to/hooks-guide.md |
| V9-DOC-DEV-012 | dev | 如何新增一个 Service（DataBridge + Envelope 路由） | guides/how-to/how-to-add-service.md |
| V9-DOC-DEV-013 | dev | 如何新增一个 Store（Zustand + withBroadcast） | guides/how-to/how-to-add-store.md |
| V9-DOC-DEV-014 | dev | 如何新增一个 Widget（WidgetShell + 事件总线） | guides/how-to/how-to-add-widget.md |
| V9-DOC-DEV-015 | dev | 如何配置 V6 评分引擎权重与阈值 | guides/how-to/how-to-configure-v6-scoring.md |
| V9-DOC-DEV-016 | dev | 如何导入导出与备份 V9 数据 | guides/how-to/how-to-data-import-export.md |
| V9-DOC-DEV-017 | dev | 如何运行采集与评分流水线 | guides/how-to/how-to-run-scoring-pipeline.md |
| V9-DOC-DEV-018 | dev | V9 常见问题排查指南 | guides/how-to/how-to-troubleshooting.md |
| V9-DOC-DEV-019 | dev | MCP 生命周期管理指南（入-移-出） | guides/how-to/MCP-LIFECYCLE-GUIDE.md |
| V9-DOC-DEV-020 | dev | V9-DOC-GUIDE-012：`no-unsafe-*` 14 种修复模式手册 | guides/how-to/no-unsafe-fix-patterns.md |
| V9-DOC-DEV-021 | dev | UI 性能最佳实践 | guides/how-to/ui-performance-best-practices.md |
| V9-DOC-DEV-022 | dev | V9 视觉回归基线管理规范 | guides/how-to/visual-regression-guide.md |
...
| V9-DOC-GUIDE-036 | guide | 07. 运营策略 | guides/07-operation-strategy.md |
| V9-DOC-GUIDE-037 | guide | 08. 实施计划 | guides/08-implementation-plan.md |
...
| V9-DOC-GUIDE-050 | guide | 03 · UI 组件设计思路（UI Component Design） | guides/team-handbook/03-ui-components.md |
| V9-DOC-GUIDE-051 | guide | 04 · 模型运行思路（Model Runtime & Data Flow） | guides/team-handbook/04-model-runtime.md |
| V9-DOC-GUIDE-052 | guide | V9 团队开发操作指南 | guides/team-handbook/06-team-operation-guide.md |
| V9-DOC-GUIDE-053 | guide | V9 智能投研复盘系统 — 新成员 30 分钟上手指南 | guides/tutorials/getting-started.md |
| V9-DOC-GUIDE-054 | guide | 踩坑规则门禁指南 | guides/踩坑规则门禁指南.md |
| V9-DOC-HOW-905 | how-to | how-to-deploy-docker-network | guides/how-to/how-to-deploy-docker-network.md |
| V9-DOC-HOW-906 | how | how-to-troubleshooting-deploy-checklist | guides/how-to/how-to-troubleshooting-deploy-checklist.md |
...
| V9-DOC-META-004 | meta | Agent 应用 · 文档分类索引表 | meta/agent-app-docs-classification.md |
| V9-DOC-META-005 | meta | V9 项目目录结构规范与使用指南 | meta/directory-structure-guide.md |
| V9-DOC-META-006 | meta | V9 文档风格统一标准（doc-style-standard） | meta/doc-style-standard.md |
| V9-DOC-META-007 | meta | 触发事件 → 更新动作 一一映射权威表 | meta/doc-trigger-action-map.md |
| V9-DOC-META-008 | meta | V9 文档元数据标准规范 | meta/document-metadata-standard.md |
| V9-DOC-META-009 | meta | V9 文档整理工作流程指南 | meta/document-organization-workflow.md |
| V9-DOC-META-010 | meta | V9 文档风格指南与命名规范 | meta/document-style-guide.md |
| V9-DOC-META-011 | meta | V9 Markdown 文档体系梳理与重构方案 | meta/markdown-reorg-framework.md |
| V9-DOC-META-012 | meta | V9 文档标签分类体系（Tag Taxonomy） | meta/tag-taxonomy.md |
