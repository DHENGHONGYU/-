...
> **关联文档**:
> - 上游：[pr-6-module-split-plan.md](./pr-6-module-split-plan.md) §5.3（原方案，本方案对其进行修订）
> - 同期：[databridge-split-completion-archive.md](./databridge-split-completion-archive.md)、[db-split-completion-archive.md](./db-split-completion-archive.md)
...
3. `docs/06-routing-specs.md` — 如有接口签名变更（本次无）
...
- [PR-6 大型模块分拆方案](./pr-6-module-split-plan.md) — 上游方案（§5.3 由 PR-7 修订）
- [db.ts 拆分归档](./db-split-completion-archive.md) — PR-6 阶段 1 归档
- [databridge 拆分归档](./databridge-split-completion-archive.md) — PR-6 阶段 2 归档
