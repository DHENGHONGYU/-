...
> **版本**: v1.0.0 | **日期**: 2026-07-13 | **阅读时长**: 5 分钟
> 完整版见 [`docs/06-project-management/lessons-learned.md`](./lessons-learned.md)
...
| 9 | **RBAC 文档断层** | 🟡 P1 | 文档双向一致性 | v24 引入完整 RBAC 权限系统（6 表+7 动作），但 `ARCHITECTURE.md` 和 `DATA_DEFINITION.md` 完全无记录。 |
...
□ 新增功能：AGENTS.md / ARCHITECTURE.md / DATA_DEFINITION.md 至少更新一份
...
> **反馈渠道**：如有新教训或已有教训的更新，提交至 `docs/06-project-management/lessons-learned.md` 完整版。
