...
| D11 | 缺少共享字段契约文档 | `./03-architecture-standards.md` | 跨模块字段语义可能漂移 | 已在 3.9.7 补充 |
...
| **D20** | **缺少热门板块与价值洼地双策略体系** | `src/services/trading/`、`src/cockpit/widgets/` | 策略引擎仅有主题/价值/热门动量三分类，缺少用户规格中的 HotSectorScore / ValuePitScore 双评分输出与轮动信号检测 | Phase 2 新增独立 Store、Analyzer、Detector、Widget；详见 `../explanation/design/2026-06-27-dual-strategy-system.md` |
