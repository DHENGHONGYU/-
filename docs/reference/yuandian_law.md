...
> **??????**: ????????????????????????????????????????  
> **????????**: [`plugins/yuandian_law/SKILL.md`](../../plugins/yuandian_law/SKILL.md)?????????? / [`plugins/yuandian_law/skills/yuandian_law/SKILL.md`](../../plugins/yuandian_law/skills/yuandian_law/SKILL.md)????????  
> **????????**: 2025-07-12
...
1. ???? `python3 scripts/yuandian_law_tool.py describe` ??????????????????
2. ?????????????? Markdown???????????????????????????????????????????? API ??????????
3. ???????????????????? API????????????????????????????????????????????????
4. ???????? Markdown ???????? `params`???????? API ??????????????????????????????????????????????????????????????????
5. ???? `python3 scripts/yuandian_law_tool.py call` ???????? API
6. ????????????????????????????????
...
*???????? [`plugins/yuandian_law/SKILL.md`](../../plugins/yuandian_law/SKILL.md) ????????????????????????????*
