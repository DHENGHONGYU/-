...
summary: "V9 双策略体系与数据流架构规格 - reference documentation (data)"
...
> 校对目标：`../explanation/03-architecture-standards.md`（已归档）、`./v9-system-blueprint.md`、  
...
2. 若采纳，按 `../explanation/design/implementation-governance.md`（已归档） 创建 ADR，状态从 `Proposal` 推进到 `Accepted`。
...
6. 同步更新 `../explanation/03-architecture-standards.md`（已归档）、`../explanation/05-engine-specs.md`、`./10-glossary.md`。
