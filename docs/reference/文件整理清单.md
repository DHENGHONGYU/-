...
| 3 | `./v9核心数据字典与类型定义(整合版).md` (v1.2) | `docs/V9核心数据字典与类型定义（整合版）.md` (v1.0) | 新版 vs 旧版 |
...
| 17 | `docs/explanation/completeness-profile-batch1~5.md` (5 文件) | 已汇总到 completeness-profile.md |
...
| 22 | `docs/explanation/dual-strategy-divergence-list.md` | 已标记 completed |
...
| `./dataflow-data-definition.md` | 数据流数据定义 |
| `./ai-center-data-definition.md` | AI 中心数据定义 |
| `./news-contract.md` | 新闻数据定义 |
...
| 文件 | 说明 |
|------|------|
| `./data-definition.md` | 驾驶舱数据定义 |
| `./data-definition.md` | 数据采集定义 |
| `./data-definition.md` | 新闻数据定义 |
...
- 核心保留文件完好：`release-notes.md`(根)、`../explanation/design/v6pro-v9-gap-analysis-final.md`、`docs/《V9核心数据字典》.md`、`./v9-system-blueprint.md` ✅
