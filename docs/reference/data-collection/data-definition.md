...
change_log:
  - version: v1.2.1
    changes: "2026-08-15 系统性核对：与 src/services/data-collector/、src/types/modules/widget.types.ts（采集相关）对齐，字段无漂移；登记为主字典 §B 内容副本，权威 SSOT 转向 docs/reference/data-definition.md v2.0.1 与 docs/reference/data-dictionary-index.md v1.1.0。"
    date: 2026-08-15
  - version: v1.2.0
