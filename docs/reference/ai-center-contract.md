---
title: ai-center-contract.md — AI 中心接口契约
status: draft
owner: 架构组
updated: 2026-07-12
---
...
| 测试类型 | 文件 | 说明 |
|----------|------|------|
| 单元测试 | `src/services/ai-center/__tests__/aiCenterProvider.test.ts` | 纯函数、数据生成逻辑（`generateAgentList`、`generateHealthMetrics`、`generateDiagnosticReports`） |
