---
title: fourth-industrial-revolution-core-resource-strategy
tier: important
code_version: 2.0.0
---
...
- **核心文件**：
  ...
  - `src/data/sectorDefinitions.ts` / `src/data/sectorSkillData.ts` — 行业/主题评分
...
| 对应哪个文档？ | 本方案文档 + ADR-008；落地后同步更新 `./02-functional-specs.md`、`./05-engine-specs.md`、`./10-glossary.md`、`./08-implementation-plan.md`。 |
...
3. 同步更新 `./02-functional-specs.md`、`./05-engine-specs.md`、`./10-glossary.md`。
