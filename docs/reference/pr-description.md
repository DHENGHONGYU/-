...
---
title: docs/reference/pr-description.md
code_version: 2.0.0
tier: important
---
...
**问题描述**：
- `../../src/showcase/index.ts` 和 `migrationValidators.ts` 中存在多个 `new DataBridge()` 实例化
...
- `../../src/showcase/index.ts`: +9 行（移除重复实例化）
