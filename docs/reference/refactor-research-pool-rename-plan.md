...
summary: "???PoolBoard / poolBoard / usePoolBoard ?????????????????????????????????ResearchPoolBoard / researchPoolBoard / useResear???
...
> **??????**: `src/` + `tests/` + `cockpit/` ?????????????????????????????????> **??????**: ???`PoolBoard` / `poolBoard` / `usePoolBoard` ?????????????????????????????????`ResearchPoolBoard` / `researchPoolBoard` / `useResearchPoolBoard`???????????????????????? `intention/research/position` ????????????????????????
---
...
**????????????**: ???????????????????????????**????????????**: ~12 ???**????????????**: ????????????????????????????????????widgetId???dataType???MarketData ?????????Store ?????????????????? cockpit???????????????Widget ????????????????????????
| ???????????? | ?????? | ?????? | ????????????|
|----------|------|------|----------|
...
**?????? ????????????**:
- `widgetId` ?????????*??????????????????????????????**???LocalStorage ???????????????`poolBoard` widgetId ???????????????????????????????????????????????????????????????????????????- `dataType` ?????????????????????????????????`MockCollector.ts` ?????????????????????
**????????????**:
```bash
npx tsc --noEmit
npm run test -- --run
...
**?????? ????????????**:
- ?????????????????????`src/components/organisms/index.ts` ????????????????????????????????????- ???????????? VSCode / WebStorm???????????? IDE ???"Rename Symbol" + "Move File" ???????????????????????????- ?????????????????????`../../AGENTS.md` ????????????????????????????????????
**????????????**:
```bash
npx tsc --noEmit
npm run test -- --run
...
- `src/config/routes.ts` ??????????????????????????????- `src/portal/PortalShell.tsx` ?????????????????????
...
# 2. ??????????????????????????????????????????????????????????????????????????????????????????grep -rn "????????? src/ tests/ --include="*.ts" --include="*.tsx" --include="*.md"

# 3. ?????????????????????????????????
grep -rn "pool-board" src/ tests/ --include="*.ts" --include="*.tsx"

# 4. ??????cockpit.constants ???????????????poolBoard ???grep -rn "poolBoard:" src/constants/cockpit.constants.ts
