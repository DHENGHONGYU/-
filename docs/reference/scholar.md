...
> **??????**: ??????????????Google Scholar ??????  
> **????????**: [`plugins/scholar/SKILL.md`](../../plugins/scholar/SKILL.md)?????????? / [`plugins/scholar/skills/scholar/SKILL.md`](../../plugins/scholar/skills/scholar/SKILL.md)????????  
> **????????**: 2025-07-12
...
1. ???? `python3 scripts/scholar_tool.py describe` ??????????????????
2. ?????????????? Markdown???????????????????????????????????????????? API ??????????
3. ???????????????????? API????????????????????????????????????????
4. ???????? Markdown ???????? `params`???????? API ????????????????????????????????????????????????????????????
5. ???? `python3 scripts/scholar_tool.py call` ???????? API
6. ????????????????????????????????
...
*???????? [`plugins/scholar/SKILL.md`](../../plugins/scholar/SKILL.md) ????????????????????????????*
