...
summary: "NewsPage 智能资讯中心数据字典：资讯实体字段、类型与来源定义�?
tags: [data, news, data-definition, reference, store]
version: v1.0.0
last_updated: 2026-07-17
code_version: 2.0.0
doc_id: V9-DOC-DATA-023
...
> **关联 PoC**：`../explanation/v6pro-to-v9-migration-analysis.md` · `../explanation/v6pro-to-v9-migration-analysis.md`
