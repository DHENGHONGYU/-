...
> **??????**: ????????????????????????????????????  
> **????????**: [`plugins/tianyancha/SKILL.md`](../../plugins/tianyancha/SKILL.md)?????????? / [`plugins/tianyancha/skills/tianyancha/SKILL.md`](../../plugins/tianyancha/skills/tianyancha/SKILL.md)????????  
> **????????**: 2025-07-12
...
1. ???? `python3 scripts/tianyancha_tool.py describe` ??????????????????
2. ?????????????? Markdown??????????????????????/?????????????????????? API ??????????
3. ???????????????????? API
4. ???????? Markdown ???????? `params`
5. ???? `python3 scripts/tianyancha_tool.py call` ???????? API
6. ????????????????????????????????
...
*???????? [`plugins/tianyancha/SKILL.md`](../../plugins/tianyancha/SKILL.md) ????????????????????????????*
