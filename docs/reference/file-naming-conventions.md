...
| 场景 | 示例 | 说明 |
|------|------|------|
| 文档章节 | `01-introduction.md`, `../team-handbook/02-architecture.md` | 按逻辑顺序编号 |
| 阶段成果 | `phase-01-report.md`, `phase-02-report.md` | 按阶段编号 |
| 版本管理 | `v1.0.0-release-notes.md` | 按版本编号 |
...
|--------|------|------|
| 序号位数 | 统一使用两位数字 | ✅ `01-` ❌ `1-` |
| 序号分隔 | 使用连字符 `-` 分隔 | ✅ `01-intro.md` ❌ `01_intro.md` |
...
| `1-intro.md` | `01-intro.md` | 序号应为两位数字 |
| `01_intro.md` | `01-intro.md` | 序号后使用连字符 |
