...
summary: "V6 Pro UI 模块与 V9 新旧比对及吸收报告（已废弃，仅存档）。"
...
> 将 `../explanation/completeness-profile-batch4.md` 的界面功能模块比对结论与 V9 当前 UI 体系校对，明确哪些模式/组件应纳入 V9，哪些应保持现状或暂缓。
...
| `RiskBanner` | `src/components/organisms/trading/RiskControlPanel.tsx` | P1 | V6 Pro 风控三态 |
| `FinalConfirm` | `src/pages/trading/components/TradeModal.tsx` | P1 | V6 Pro 最终确认关卡 |
| `DebaterPanel` | `src/components/organisms/analysis/score/IntelligentScoreExplanation.tsx` | P2 | V6 Pro 多空辩论 |
| `GatewayPanel` | `src/pages/command/MCPServerDashboardPage.tsx` | P2 | V6 Pro 系统网关面板 |
| `ReviewDrawer` | `src/components/organisms/output/ReviewWizard.tsx` | P2 | V6 Pro 信号质量复盘 |
| `ReportGenerator` | `src/services/hybrid-proofread/reportGenerator.ts` | P2 | V6 Pro 报告生成 |
| `LoopBanner` | `src/portal/PortalShell.tsx` | P2 | V6 Pro 回路状态提示 |
