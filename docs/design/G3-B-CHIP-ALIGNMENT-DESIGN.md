...
change_log:
  - version: 1.0.3
    changes: "基准校对(2026-08-23)：A类双轨(fm 1.0.2 / 正文 1.0) → 取真值 max=1.0.2 → PATCH++ 对齐 frontmatter/正文/change_log 三轨"
    date: 2026-08-23
  - version: 1.0.2
    changes: "基准日校对(2026-08-22)：R1取真值(P1 change_log 最新条目=1.0.1) → R2 PATCH++(1.0.2) / last_updated 刷新 / change_log 闭环"
    date: 2026-08-22
- version: 1.0.1
