...
- [ ] **路由注册**: 新增页面在 `routes.ts` + App 分发器 + `../archive/historical-2026-08-16/batch7/docs/explanation/06-routing-specs.md（已归档）` 三处同步更新
...
- [ ] **文档同步**: 类型定义变更同步更新 `../archive/historical-2026-08-16/batch7/docs/explanation/06-routing-specs.md（已归档）` 或数据字典
