...
**操作清单**:
1. 修改 `src/utils/timeUtils.ts:31-33`
...
**操作清单**:
1. 新增 `src/services/scoring/_shared/weightedScore.ts`
...
- [AP-007 重复代码检测策略 A（保守合并）](../../01-requirements/03-architecture-standards.md)
