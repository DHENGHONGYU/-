...
| 3 | `docs/data-collection/DATA_DEFINITION.md` | v1.1.0 | v1.2.0 | CollectorConfig +1 字段 + dataType 扩展 |
| 4 | `docs/news/DATA_DEFINITION.md` | v1.1.0 | v1.2.0 | NewsBookmark 接口 + 行号修正 |
| 5 | `docs/06-routing-specs.md` | v3.0.0 | v3.1.0 | 数量统计修正（47→48） |
| 6 | `docs/implementation/quality-audit-plan.md` | v1.0.0 | v1.1.0 | 全量审计完成 + 入口补全 |
| 7 | `docs/implementation/completeness-profile.md` | — | v1.0.0 | 新建：五层追溯完成度剖面图 |
| 8 | `docs/implementation/action-list.md` | — | v1.0.0 | 新建：35 项修复行动清单 |
...
### 2.2 AI_CENTER_DATA_DEFINITION.md
...
### 2.3 data-collection/DATA_DEFINITION.md
...
| AI_CENTER_DATA_DEFINITION.md | 6 | 6 | 0 |
| news/DATA_DEFINITION.md | 4 | 4 | 0 |
| data-collection/DATA_DEFINITION.md | 2 | 2 | 0 |
| **合计** | **15** | **15** | **0** |
...
| 2026-07-05 15:00 | 交付物生成 | completeness-profile.md + action-list.md + 更新 audit-plan |
