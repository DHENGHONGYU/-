...
| NSIS 安装包 | `release/FinSightV9 Setup 2.0.0-rc.1.exe` | 589 MB |
...
| `src/services/fetcher/fetcherClient.ts` | 修改 | 端口 8765 → 8000（baseURL 修正） |
| `src/services/fetcher/fetcherClient.test.ts` | 修改 | 端口 8765 → 8000（测试用例同步） |
