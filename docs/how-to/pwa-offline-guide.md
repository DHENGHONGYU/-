...
summary: "?????????? V9 ?????????? PWA ?????????????????????? Service Worker ???????????????????????????????????????????????????????? Lighthouse ??????????????"
tags: [project, guide, implementation, component, how-to]
version: v1.0.0
last_updated: 2026-07-17
code_version: 2.0.0
doc_id: V9-DOC-PROJ-071
referenced_by: [V9-DOC-PROJ-157, docs/00-meta/deprecated-docs/old-versions/registry-index-v1.0.0-02-design.md]
change_log:
  - version: v1.0.0
...
> **????????**??`../reference/v9-system-blueprint.md` ??1 ????????????????????????8 Phase 3??PWA manifest + service worker??????9 ???????? 11??PWA ??????????????10 ???? D18/D19 ??????????????
> **????????**??`../reference/03-architecture-standards.md` ??3.10.1??????????????`../reference/06-routing-specs.md`??HashRouter ??????????????

---

## 1. ??????????

?????????? V9 ?????????? PWA ?????????????????????? Service Worker ???????????????????????????????????????????????????????? Lighthouse ?????????????????????????????????????????????? `../reference/chart-integration.md`??`../reference/feedback-loop-spec.md`????
...
> `feedbackService` ?????? `../reference/feedback-loop-spec.md` ??3??
...
- IndexedDB ?????????????? PWA ??????????????
- ?? `DB_VERSION` ????????SW precache ?????????? IndexedDB ??????
- ?????????????? IndexedDB ??????????????????????????????????????????
...
- ?????? `npx playwright test tests/pwa-offline.spec.ts`??Phase 3 ????????
...
- `../reference/06-routing-specs.md` ??1??HashRouter ??????
- `../reference/feedback-loop-spec.md` ??5.3??pwa:* ???????? EventBus ???? Toast??
