...
---
title: docs/how-to/hooks-guide.md
code_version: 2.0.0
tier: important
---
...
> **Related**: `src/hooks/`、`../reference/data-flow-spec.md`、`../../AGENTS.md` §三 事件监听清理
...
| 动作 | 文档 |
|------|------|
| 主更新动作 | 本文档（`./hooks-guide.md`） |
| 补充文档 | `../reference/data-flow-spec.md` |
| 写后校验 | `npm run audit:docs`（是） |

详见 `docs/00-meta/doc-trigger-action-map.md` §二 T7 行。
