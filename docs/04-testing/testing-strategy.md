...
> **版本**: v2.0.0 | **日期**: 2026-07-12
> **适用范围**: V9 智能投研复盘系统所有新增模块
> **配套文档**: [测试资产目录与清单](../testing/test-catalog.md) — 全量测试文件索引与已知问题追踪
...
| 文档 | 路径 | 内容 |
|------|------|------|
| 测试资产目录 | `docs/testing/test-catalog.md` | 全量测试文件索引、按舱室/服务/Store 分类清单 |
| AGENTS.md 测试约束 | `AGENTS.md` §二/三/七 | 四步集成回滚验证、事件监听清理模板、验证命令 |
| 编码规范 | `docs/standards/coding-conventions.md` | 测试命名与目录约定 |
