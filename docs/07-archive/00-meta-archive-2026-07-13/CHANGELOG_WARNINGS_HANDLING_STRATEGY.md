...
| 分类 | 典型路径 | 说明 |
|:---|:---|:---|
| 旧版架构文档 | `docs/03-architecture-standards.md` | 已迁移到 `docs/02-design/architecture/` |
| 代码审查文档 | `docs/CODE-REVIEW.md` | 已迁移到 `docs/03-development/code-review-guide.md` |
| 数据定义文档 | `docs/RISK_DERIVED_DATA_DEFINITION.md` | 已归档到 `archive/docs/07-archive/` |
| UI 组件 | `src/components/ui/PageContainer.tsx` | 组件结构变更 |
...
| 旧路径 | 新路径 | 状态 |
|:---|:---|:---|
| `docs/03-architecture-standards.md` | `docs/02-design/architecture/ARCHITECTURE.md` | ✅ 映射 |
| `docs/CODE-REVIEW.md` | `docs/03-development/code-review-guide.md` | ✅ 映射 |
| `docs/RISK_DERIVED_DATA_DEFINITION.md` | `archive/docs/07-archive/RISK_DERIVED_DATA_DEFINITION.md.DEPRECATED` | ✅ 已归档 |
| `docs/DATA_DICTIONARY_INDEX.md` | `docs/02-design/DATA_DICTIONARY_INDEX.md` | ✅ 映射 |
| `docs/CODE-REVIEW-CHEATSHEET.md` | `docs/03-development/code-review-guide.md` | ✅ 已合并 |
| `docs/CODE-REVIEW-TRAINING.md` | `docs/03-development/code-review-guide.md` | ✅ 已合并 |
| `docs/SOLO-REVIEW.md` | `docs/03-development/code-review-guide.md` | ✅ 已合并 |
| `docs/TECH-DEBT.md` | `docs/02-design/TECH-DEBT.md` | ✅ 映射 |
