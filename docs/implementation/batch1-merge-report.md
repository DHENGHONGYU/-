...
|----------|----------|------------|------|----------|
| `docs/03-architecture-standards.md` | 修改 | Doc-Sync | ✅ 已完成 | lint ✅ / build ✅ |
| `docs/06-routing-specs.md` | 修改 | Doc-Sync | ✅ 已完成 | lint ✅ / build ✅ |
| `docs/08-implementation-plan.md` | 修改 | Doc-Sync | ✅ 已完成 | lint ✅ / build ✅ |
| `docs/09-quality-gates.md` | 修改 | Doc-Sync | ✅ 已完成 | lint ✅ / build ✅ |
...
6. **README 与 implementation 文档**
   ...
   - `v9-system-blueprint.md` 同步 store 数量、质量基线、偏差清单、ADR 列表。
...
| `npm run coverage` | ⚠️ 阈值告警 | 当前覆盖率未达设定阈值，详见 Refactor-Agent 报告 |
