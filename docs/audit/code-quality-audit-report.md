...
- 硬编码分析详细报告（生成时存于本地 output/hardcode_analysis_final_report.json）
- 代码复杂度报告（生成时存于本地 output/code_quality_report.json）
- 类型安全报告（生成时存于本地 output/typescript_analysis_results.json）
