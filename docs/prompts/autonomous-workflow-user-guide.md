...
| 触发�?| 监控路径 | 需要更新的文档 |
|--------|---------|---------------|
| **T1 类型定义变更** | `src/data/types.ts`<br>`src/types/modules/*.ts`<br>`src/services/scoring/v6-engine/types.ts` | `../reference/data-dictionary-index.md`<br>`../reference/v9核心数据字典与类型定�?整合�?.md` |
| **T2 接口变更** | `src/services/**/index.ts`<br>`src/core/databridge.ts`<br>`src/data/dataLayer.ts` | `../reference/api-contract.md`<br>`../reference/databridge端点与数据映射清�?md` |
