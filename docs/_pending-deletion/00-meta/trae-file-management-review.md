...
| `.trae/` | **存在**（rules/、`skills/featur/SKILL.md`、mcp.json、logs/、documents/ 等 13 文件） | `find` |
| `scripts/` | **存在** | `ls -d` |
...
5. 🟡 缺 `docs/README.md` 主控索引、`./GONANCE.md`、单一 Living PRD；`drafts/plans/blueprints` 囤积中间文档。
...
| 动作 | 对应 TRAE 规则 | 文件/目录 | 验收 |
|------|----------------|-----------|------|
| 建 `./GONANCE.md`（收口 9 份 ADR 式文档）+ 单一 Living PRD 索引（指向 `01-requirements/`） | 3 文件底线 | 根级 / `../reference/README.md` | 决策有主索引、需求有唯一源 |
