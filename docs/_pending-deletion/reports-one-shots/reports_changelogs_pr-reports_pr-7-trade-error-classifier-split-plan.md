...
type: reference
domain: project
doc_id: V9-DOC-AUTO-74D3F5
code_version: 2.0.0
summary: 针对 PR-6 §5.3 中 tradeErrorClassifier.ts（767 行，12 类错误检测）的拆分方案进行依赖关系深度分析，确认拆分边界是否合理，并基于真实依赖关系修订原方案。
...
- [AGENTS.md v1.3.4](../../../meta/AGENTS.md) — 项目分层规则与编码契约
