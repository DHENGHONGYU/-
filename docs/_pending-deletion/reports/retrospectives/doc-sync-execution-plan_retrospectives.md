...
| 架构说明 | `../../explanation/03-architecture-standards.md`、`../../reference/03-architecture-standards_reference.md` | 新增模块、调整分层、新增路由/注册表时 |
| 实施计划 | `../../reference/08-implementation-plan_reference.md` | 任务状态变更、新增/拆分任务时 |
| 路由规格 | `../../reference/06-routing-specs_reference.md` | 新增/修改路由、页面组件时 |
| 引擎规格 | `../../reference/05-engine-specs_reference.md` | 新增/修改引擎、算法、数据流时 |
| 质量门禁 | `../../reference/09-quality-gates_reference.md` | 测试基线、审计基线变化时 |
...
| 路由 | 新增路由是否在 `../../reference/06-routing-specs_reference.md` 中注册 | 比对 `src/config/routes.ts` 与文档 |
...
| 4 | 补齐 AI 中心板块字典与 Vue3 示例 | P0 | AI Center 代码 | `../../AI_CENTER_DATA_DEFINITION.md`、`../../explanation/ai-center-vue3-examples.md` | 已输出并通过验证 |
...
| 10 | 更新 `../../reference/08-implementation-plan_reference.md` | P1 | 任务 1, 4 | 在实施计划中新增“文档同步”任务列，状态可追踪 |
| 11 | 数据字典索引页 | P1 | 任务 2, 3, 4 | `../../reference/data-dictionary-index_reference.md`：汇总所有模块数据字典入口 |
...
- 在 `../../reference/08-implementation-plan_reference.md` Phase 2 中新增任务 **“2.22 代码-文档同步机制”**，归属 P1，依赖 2.1/2.3/2.13。
...
| 角色 | 职责 |
|------|------|
| **架构师 / Tech Lead** | 审批文档同步方案；评审架构说明与数据字典；维护 `../../reference/03-architecture-standards_reference.md` |
...
| AI 中心板块 | `src/constants/ai-center.constants.ts`、`src/services/ai-center/*` | `../../AI_CENTER_DATA_DEFINITION.md`、`../../explanation/ai-center-vue3-examples.md` | tsc/lint 通过 |
