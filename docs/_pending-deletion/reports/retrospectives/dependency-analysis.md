...
- src/services/data-collector/dimensionDataTypes.ts
...
- src/services/scoring/v6-engine/adapters.ts
...
- src/store/__tests__/profileStore.minQuality.test-data.ts
...
- src/types/modules/loop.types.ts
...
- src/types/modules/registration-contract.types.ts
