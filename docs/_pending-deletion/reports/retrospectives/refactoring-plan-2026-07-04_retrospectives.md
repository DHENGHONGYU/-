---
title: refactoring-plan-2026-07-04
type: reports
domain: backend
phase: planning
tier: T2
...
summary: "V9 系统代码重构执行方案：Top 10 需拆分文件："
tags: [backend, refactor, system]
version: v1.0.0
last_updated: 2026-07-17
code_version: 2.0.0
doc_id: V9-DOC-BACK-043
referenced_by: [V9-DOC-PROJ-174, V9-DOC-META-000, V9-DOC-PROJ-176, V9-DOC-PROJ-182, docs/meta/deprecated-docs/old-versions/registry-index-v1.0.0-02-design.md]
change_log:
  - version: v1.0.0
...
2. 优先治理高频违规文件（`reference/cockpit/widgets/*`、`apps/trading/*`）
3. 使用正则替换批量修复
