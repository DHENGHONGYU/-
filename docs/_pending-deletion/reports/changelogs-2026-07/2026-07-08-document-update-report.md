...
|---------|---------|---------|---------|---------|
| data-dictionary-index_reference.md | `../reference/data-dictionary-index_reference.md` | v1.5.0 → v1.6.0 | 2026-07-08 14:02 | 新增模块索引 |
| CHANGELOG_reference.md | `./CHANGELOG.md` | v2.5.0 → v2.6.0 | 2026-07-08 14:03 | 新增版本记录 |
| 03-architecture-standards_reference.md | `../reference/03-architecture-standards_reference.md` | v2.5.0 → v2.6.0 | 2026-07-08 14:04 | 新增模块说明 |
| 05-engine-specs_reference.md | `../reference/05-engine-specs_reference.md` | v2.5.0 → v2.6.0 | 2026-07-08 14:04 | 新增引擎规格 |
...
| 修改项 | 位置 | 说明 |
|-------|------|------|
| 数据字典索引 | `../reference/data-dictionary-index_reference.md` §按模块索引 | 新增混合校对模块条目，包含 17 个类型定义 |
...
### 5.1 data-dictionary-index_reference.md
...
### 5.3 03-architecture-standards_reference.md
...
### 5.4 05-engine-specs_reference.md
