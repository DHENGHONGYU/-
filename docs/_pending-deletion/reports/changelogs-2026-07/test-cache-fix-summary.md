...
summary: "`dataBridge` 是单例对象（`export const dataBridge = new DataBridge()`），其内部的 `readCache`（MemoryCache 实例）在测试用例间持久存在。`db.reset()`"
tags: [report, changelog]
version: v1.0.0
last_updated: 2026-07-23
code_version: 2.0.0
doc_id: V9-DOC-AUTO-90059E
tier: T1
---
