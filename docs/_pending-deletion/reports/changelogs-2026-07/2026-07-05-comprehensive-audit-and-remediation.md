...
type: reference
domain: project
doc_id: V9-DOC-AUTO-2B7A88
code_version: 2.0.0
summary: - P0 批次修复：`routes.ts` 中 `segments[0]` possibly undefined（添加 null check）
...
| 问题域 | 记录状态 | 记录位置 |
|--------|---------|---------|
| P0/P1/P2 批次整改 | ✅ 完整 | `action-list-p1.md` / `completeness-profile-p1.md` / `2026-07-05-p2-completion-and-backlog_2026-07.md` |
...
| CHANGELOG v2.2.1 文档修正 | ✅ 完整 | `docs/CHANGELOG.md` |
