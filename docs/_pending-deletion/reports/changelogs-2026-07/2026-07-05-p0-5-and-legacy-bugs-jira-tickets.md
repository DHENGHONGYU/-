...
type: reference
domain: project
doc_id: V9-DOC-AUTO-E9B271
code_version: 2.0.0
summary: `ConfigApp.updateField` 使用 `Number(e.target.value)` 转换输入值,未对 NaN / Infinity 做守卫。
...
> **关联文档**: `docs/changelogs/2026-07/2026-07-05-comprehensive-audit-and-remediation.md`
> **Status**: 全部 Done / Resolved
...
| 2 | 在 CHANGELOG_reference.md 中补充 P0-5 缺陷修复条目 | Maintainer | 2026-07-06 | Pending |
