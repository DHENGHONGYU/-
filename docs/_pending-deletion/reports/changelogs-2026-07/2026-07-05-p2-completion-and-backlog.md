...
type: reference
domain: project
doc_id: V9-DOC-AUTO-898D7F
code_version: 2.0.0
summary: - 新建 `tests/__tests__/types/data-types.spec.ts`
...
| 硬编码 URL | 14 | 迁移到 `src/config/apiEndpoints.ts` |
| 硬编码 API 路径 | 6 | 迁移到 `src/config/apiEndpoints.ts` |
