...
type: reference
domain: project
doc_id: V9-DOC-AUTO-2F02B6
code_version: 2.0.0
summary: 问题代码（`audit-layer-calls.ts` v2.0）：
...
| 7 | `src/services/useCase/submitOrder.useCase.ts` | 18 | `import { withBroadcast } from '@/store/helpers/withBroadcast'` | `import { withBroadcast } from '@/lib/withBroadcast'` | ❌ 真实违规 |
...
4. **修复方案**：修改正则表达式/检测逻辑
5. **验证修复**：运行审计脚本确认误报消除
6. **文档更新**：同步更新 AGENTS.md、CHANGELOG_reference.md
...
> 3. 更新 CHANGELOG_reference.md 记录本次修复
