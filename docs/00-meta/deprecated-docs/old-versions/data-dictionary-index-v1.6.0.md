---
title: docs/00-meta/deprecated-docs/old-versions/data-dictionary-index-v1.6.0.md
type: meta
domain: data
phase: design
tier: reference
...
summary: "docs/00-meta/deprecated-docs/old-versions/data-dictionary-index-v1.6.0.md"
tags: [data, data-definition, registry, documentation, deprecated]
version: v1.0.0
last_updated: 2026-07-17
code_version: 2.0.0
change_log:
  - version: v1.0.0
deprecated_by: "Data Dictionary Index v2.0"
...
| 模块 | 数据字典 | 源码入口 | 覆盖范围 |
|------|----------|----------|----------|
| 交易持仓管理 | `../../../reference/data-definition.md`（§A）、`../../../reference/api-contract.md` | `src/pages/trading/`、`src/types/modules/trade.types.ts`、`src/constants/trade.constants.ts`、`src/store/holdingsStore.ts` | 持仓明细、查询参数、交易操作、分页/筛选状态、Store 状态管理（Zustand） |
...
| 金融业务驾驶舱 Widget | `../../../reference/data-definition.md`（§B 数据采集 / §C Cockpit Widget 框架） | `src/cockpit/widgets/`、`src/services/stock-analysis/`、`src/services/data-collector/`、`src/types/modules/widget.types.ts`、`src/store/widgetStore.ts` | 投资画像、股票池、KAI 评分、模型对比、聊天界面、Widget 实例管理 |
