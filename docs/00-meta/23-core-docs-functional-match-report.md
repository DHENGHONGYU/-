...
summary: "23 个核心文档按功能/内容匹配（非文件名）的最终核查报告，含统计汇总与缺口清单。"
...
- **判定理由**：无独立Store集成规范；仅../../prompts/store-prompt-template.md有片段

**10. `../prompts/service-integration-guide.md`** ??

- **预期功能**：Service集成规范（从prompts抽离）
- **判定理由**：无独立Service集成规范；仅../../prompts/service-prompt-template.md有片段
...
> **建议**：对『部分满足』的5个文档，无需从零新建，可在现有文档基础上补充扩展（如 `../reference/ai-memory-layer.md` 扩展为 `../README.md`，`../explanation/a11y-checklist.md` 补充i18n章节等）。
