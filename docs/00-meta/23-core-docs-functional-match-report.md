...
**4. `docs/architecture/cabins-overview.md`** 🔴
...
**6. `docs/01-requirements/adr/README.md`** 🔴
...
**8. `docs/modules/data-layer-overview.md`** 🔶
...
**11. `docs/standards/coding-conventions.md`** ✅
...
**12. `docs/design/song-aesthetics.md`** 🔶
...
**13. `docs/standards/quality-gates.md`** ✅
...
**14. `docs/testing/test-catalog.md`** 🔴
...
- **`docs/architecture/cabins-overview.md`** — 5舱体系是V9核心卖点，当前仅input舱有spec
- **`docs/architecture/adr/README.md`** — 9份ADR散落，无集中索引影响检索效率
- **`docs/guides/getting-started.md`** — 新人onboarding必备，降低上手门槛

### 🟡 中优先级

- **`docs/modules/data-layer-overview.md`** — 补齐DataBridge/collection端到端地图（V9_IndexedDB_Store_Schema已覆盖IndexedDB部分）
- **`docs/ai/README.md`** — AI工程入口，串联四件套（可从ai-memory-layer扩展）
- **`docs/design/song-aesthetics.md`** — 品牌设计哲学，可从design-tokens/ui-design-system提炼
- **`docs/architecture/api-contracts.md`** — 全局接口契约，可从DataBridge系列4份文档+API_CONTRACT整合

### 🟢 低优先级

- **`docs/GOVERNANCE.md`** — 文档保鲜度与DoD规则，可从00-README.md提升
- **`docs/testing/test-catalog.md`** — 测试用例集中维护
- **`docs/ai/store-integration-guide.md + service-integration-guide.md`** — 从prompts模板抽离为独立文档
- **`docs/architecture/security-model.md`** — 安全合规
- **`docs/ops/deployment.md + runbook.md`** — 运维SRE
- **`docs/guides/how-to-add-store.md + how-to-add-service.md`** — 操作指南（AGENTS.md已有四步集成描述）
...
> **建议**：对『部分满足』的5个文档，无需从零新建，可在现有文档基础上补充扩展（如 `ai-memory-layer.md` 扩展为 `ai/README.md`，`a11y-checklist.md` 补充i18n章节等）。
