...
tags: [project, log, meta, governance, documentation]
version: v1.0.0
last_updated: 2026-07-17
code_version: 2.0.0
doc_id: V9-DOC-PROJ-006
...
- **现象**：Markdown 链接示例 `[示例文本](../reports/audit/file-management-compliance-report-2026-07-12.md)` 中的链接文本被误识别为断裂引用
- **原因**：反引号正则同时捕获了链接文本
...
| docs/00-meta/FILE-MANAGEMENT-GUIDE-file-wandering-report.md | 去掉 src/core/、src/lib/ 目录描述的反引号 |
| docs/00-meta/执行校验报告.md | 去掉 JSX 标签未闭合问题描述的反引号 |
...
| docs/reference/v10-architecture-alignment.md | 去掉本地绝对路径反引号 |
| docs/explanation/design/踩坑规则门禁指南.md | 将 file:/// 本地链接改为纯文本说明 |
| scripts/fix/fix-repeated-relative-paths.ts | 示例路径反引号改为双引号 |
| scripts/build/deploy-rectification-toolkit.ts | console.log 中硬编码 README.md 改为 path.basename 变量 |
