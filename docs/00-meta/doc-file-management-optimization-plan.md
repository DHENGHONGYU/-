...
---
title: docs/00-meta/doc-file-management-optimization-plan.md
code_version: 2.0.0
tier: core
---
...
| A–H 索引（幽灵） | `../explanation/a-h-index.md` v1.0.0 | 声称"逻辑层 A–H + 物理层双轨制"，但链接的 `A/a-navigation-governance.md`、`B/b-architecture-design.md` 等 **50+ 文件磁盘全不存在**（已用 `ls docs/A…docs/H` 实测确认） |
...
| `../../../../CHANGELOG.md` | `../reports/changelogs/../../CHANGELOG.md` | 根 `../../CHANGELOG.md` |
