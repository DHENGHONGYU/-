...
- `InputApp` 分发器的 else-if 链可能膨胀（从 4 分支到 8 分支）。
  - **技术债**：`docs/02-design/TECH-DEBT.md` — 「InputApp 分发器路由表膨胀」（待评估 switch/映射表重构）。
...
| 文档 | 路径 |
|------|------|
| 路由规格 | `../../02-design/06-routing-specs.md` §3.2 |
| 舱室总览 | `../cabins-overview.md` §1 |
| 原始提案 | `../../03-development/2026-06-24-input-cabin-subpages.md` |
