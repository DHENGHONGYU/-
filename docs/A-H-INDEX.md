...
> 物理目录为 `docs/00-meta` ~ `docs/07-archive` + 顶层 `reports/ prompts/ assets/`。本文件位于 `docs/A-H-INDEX.md`。
...
- [目录结构指南](00-meta/DIRECTORY_STRUCTURE_GUIDE.md)
- [文档注册索引](00-meta/REGISTRY_INDEX.md)
- [文档自动更新触发映射](00-meta/doc-trigger-action-map.md)
- [文档与文件管理优化方案](00-meta/doc-file-management-optimization-plan.md)
- [需求 / 愿景 / 架构标准](01-requirements/)（含 `v9-system-blueprint.md`、`01-vision-and-goals.md`、`02-functional-specs.md`、`03-architecture-standards.md`、`V9数据宪法.md`）
- [数字目录结构总入口](../README.md)

### [B] 架构设计
- [架构概览](02-design/architecture/overview.md)
- [子系统架构（ARCHITECTURE.md）](02-design/architecture/subsystems/ARCHITECTURE.md)
- [舱室总览](02-design/architecture/cabins-overview.md)
- [服务目录](02-design/architecture/services-catalog.md)
...
- [数据定义](02-design/standards/DATA_DEFINITION.md)
- [数据字典索引](02-design/standards/DATA_DICTIONARY_INDEX.md)
- [各类业务数据定义](02-design/standards/)（`*-data-definition.md`）

### [D] 技术规范
- [编码规范](02-design/standards/coding-conventions.md)
- [JSDoc 规范](02-design/standards/jsdoc-convention.md)
- [复杂度治理](02-design/standards/complexity-governance.md)
- [设计令牌](02-design/standards/design-tokens/)
- [开发工作流 SOP](02-design/standards/development-workflow-sop.md)
- [代码评审指南](02-design/standards/code-review-guide.md)
- [网关写入权限规范](02-design/standards/gateway-write-permission-spec.md)
...
- [草稿](reports/drafts/)
- [发布管理](reports/release-management/)、([发布说明](05-deployment/RELEASE_NOTES.md))
...
- [PR 说明模板](05-deployment/PR_DESCRIPTION.md)
