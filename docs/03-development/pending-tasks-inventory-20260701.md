...
来源：`docs/08-implementation-plan.md` L154-164
...
来源：`docs/08-implementation-plan.md` L170-176
...
来源：`docs/08-implementation-plan.md` L182-187

| # | 任务描述 | 验证状态 | 说明 |
|---|---------|---------|------|
| 17 | 完整功能验收（对照 `docs/02-functional-specs.md` 与 `docs/09-quality-gates.md`） | 🟡 待执行 | 需要系统性验收流程 |
...
来源：`docs/implementation/factor-tracking-roadmap.md` L60-94
...
1. **`docs/08-implementation-plan.md`**
...
3. **`docs/implementation/pending-tasks-inventory-20260701.md`**（本文档）
