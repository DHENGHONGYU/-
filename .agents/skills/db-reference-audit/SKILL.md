...
change_log:
  - version: v1.0.2
    ...
    date: 2026-08-21
  - version: v1.0.1
    changes: "Batch-B P0-1 段补齐：基于 S 级 Skill 5 段式骨架模板重构，原 5 段自定义标题重映射为标准一~五段；§二前置检查表格化；§三审计 SOP 拆 4 个 Phase；§四扩展至 8 条教训（后果+规避双字段）；§五交付物≥10 项+必要且充分条件声明；补 mandatory 字段对齐 registry。"
    date: 2026-08-21
  - version: v1.0.0
...
> **版本**: v1.0.1 | **日期**: 2026-08-21 | **校验基准**: V9 v2.0.0 / DB_VERSION 28+
