...
|------|------:|------:|------:|------:|------:|------:|------:|------:|------:|
| sh601688 | 98.8 | 98.8 | 86.7 | **94.7** | 0.0 | 0.0 | 0.0 | 0.0 | 94.7 |
| sh600519 | 97.0 | 97.0 | 99.7 | **97.9** | 0.0 | 0.0 | 0.0 | 0.0 | 97.9 |
| sh601669 | 95.2 | 95.2 | 84.4 | **91.6** | 0.0 | 0.0 | 0.0 | 0.0 | 91.6 |
| sz002594 | 96.1 | 96.1 | 94.5 | **95.6** | 0.0 | 0.0 | 0.0 | 0.0 | 95.6 |
| sh600036 | 96.2 | 96.2 | 86.9 | **93.1** | 0.0 | 0.0 | 0.0 | 0.0 | 93.1 |
| sh601318 | 99.9 | 99.9 | 89.8 | **96.5** | 0.0 | 0.0 | 0.0 | 0.0 | 96.5 |
| sh601012 | 96.3 | 96.3 | 87.4 | **93.3** | 0.0 | 0.0 | 0.0 | 0.0 | 93.3 |
| sz002352 | 98.3 | 98.3 | 85.3 | **94.0** | 0.0 | 0.0 | 0.0 | 0.0 | 94.0 |
| sh601933 | 99.5 | 99.5 | 86.2 | **95.1** | 0.0 | 0.0 | 0.0 | 0.0 | 95.1 |
| sz002304 | 93.8 | 93.8 | 87.3 | **91.7** | 0.0 | 0.0 | 0.0 | 0.0 | 91.7 |
| **均值** | **97.1** | **97.1** | **88.8** | **94.4** | **0.0** | **0.0** | **0.0** | **0.0** | **94.4** |

## 3. 聚合结论

| 指标 | AFTER(接入后) | BEFORE(基线) | 提升 |
|------|------:|------:|------:|
| 04 公告综合 | 97.1 | 0.0 | 97.1 |
| 05 新闻综合 | 97.1 | 0.0 | 97.1 |
