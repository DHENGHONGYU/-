...
| sh600036 | 96.3 | 96.3 | 86.9 | **93.2** | 0.0 | 0.0 | 0.0 | 0.0 | 93.2 |
...
| sh601933 | 99.6 | 99.6 | 86.2 | **95.2** | 0.0 | 0.0 | 0.0 | 0.0 | 95.2 |
| sz002304 | 93.9 | 93.9 | 87.3 | **91.7** | 0.0 | 0.0 | 0.0 | 0.0 | 91.7 |
| **均值** | **96.8** | **96.8** | **88.8** | **94.2** | **0.0** | **0.0** | **0.0** | **0.0** | **94.2** |

## 3. 聚合结论

| 指标 | AFTER(接入后) | BEFORE(基线) | 提升 |
|------|------:|------:|------:|
| 04 公告综合 | 96.8 | 0.0 | 96.8 |
| 05 新闻综合 | 96.8 | 0.0 | 96.8 |
