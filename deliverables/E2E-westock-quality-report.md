...
| 08 研报综合 | 79.5 | 0.0 | 79.5 |
| **综合质量** | **90.8** | **0.0** | **90.8** |
| westock 连接可用率 | 96.7% (29/30) | — | — |
...
- **连接可靠性**：westock 真实 CLI 调用可用率 96.7%，失败显式经 recordSourceResult 计分并降级（方案 §5.4 优雅降级）。
