...
|------|------:|------:|------:|------:|------:|------:|------:|------:|------:|
| sh601688 | 99.1 | 99.1 | 86.6 | **94.9** | 0.0 | 0.0 | 0.0 | 0.0 | 94.9 |
| sh600519 | 96.9 | 96.9 | 99.6 | **97.8** | 0.0 | 0.0 | 0.0 | 0.0 | 97.8 |
| sh601669 | 96.0 | 96.0 | 84.3 | **92.1** | 0.0 | 0.0 | 0.0 | 0.0 | 92.1 |
| sz002594 | 96.1 | 96.1 | 94.4 | **95.6** | 0.0 | 0.0 | 0.0 | 0.0 | 95.6 |
| sh600036 | 96.8 | 96.8 | 86.8 | **93.5** | 0.0 | 0.0 | 0.0 | 0.0 | 93.5 |
| sh601318 | 99.9 | 99.9 | 98.4 | **99.4** | 0.0 | 0.0 | 0.0 | 0.0 | 99.4 |
| sh601012 | 96.3 | 96.3 | 87.3 | **93.3** | 0.0 | 0.0 | 0.0 | 0.0 | 93.3 |
| sz002352 | 98.3 | 98.3 | 85.2 | **93.9** | 0.0 | 0.0 | 0.0 | 0.0 | 93.9 |
| sh601933 | 99.8 | 99.8 | 86.1 | **95.2** | 0.0 | 0.0 | 0.0 | 0.0 | 95.2 |
| sz002304 | 93.8 | 93.8 | 87.2 | **91.6** | 0.0 | 0.0 | 0.0 | 0.0 | 91.6 |
| **均值** | **97.3** | **97.3** | **89.6** | **94.7** | **0.0** | **0.0** | **0.0** | **0.0** | **94.7** |

## 3. 聚合结论

| 指标 | AFTER(接入后) | BEFORE(基线) | 提升 |
|------|------:|------:|------:|
| 04 公告综合 | 97.3 | 0.0 | 97.3 |
| 05 新闻综合 | 97.3 | 0.0 | 97.3 |
| 08 研报综合 | 89.6 | 0.0 | 89.6 |
| **综合质量** | **94.7** | **0.0** | **94.7** |
