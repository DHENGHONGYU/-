...
- Name: functional\buttons.spec.ts >> 按钮交互测试 >> 首页"打开驾驶舱"按钮 >> 首页"打开驾驶舱"按钮应存在且可见
- Location: functional\buttons.spec.ts:20:5
...
Locator: getByRole('button', { name: '打开驾驶舱' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: '打开驾驶舱' })
