...
- Name: functional\navigation.spec.ts >> 导航跳转测试 >> 首页导航到五个舱室 >> 从首页导航到总控舱
- Location: functional\navigation.spec.ts:41:5
...
Locator: getByRole('heading', { name: '总控舱', level: 1 })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: '总控舱', level: 1 })
    - waiting for" http://localhost:3005/" navigation to finish...
    - navigated to "http://localhost:3005/#//command"
