...
- Name: functional\navigation.spec.ts >> 导航跳转测试 >> 输入舱侧边栏面板导航 >> 侧边栏"采集任务监控"按钮导航到采集任务监控页
- Location: functional\navigation.spec.ts:68:5
...
Locator: getByRole('heading', { name: '输入舱' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: '输入舱' })
    - waiting for" http://localhost:3005/" navigation to finish...
    - navigated to "http://localhost:3005/#//input"
